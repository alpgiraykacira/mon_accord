  ...
  `,x(),e.querySelector(`#scroll-hint`).addEventListener(`click`,()=>{document.getElementById(`origin-section`)?.scrollIntoView({behavior:`smooth`})}),e.querySelector(`#bottom-cta`).addEventListener(`click`,()=>{t(n?`#lab`:`#profile`)});let r=[0,1,2,3,4,5];function i(t){return e.querySelector(`.cf-card[data-index="${t}"]`)}function a(e,t,n=!1){let r=Math.abs(t),i=t*230,a=r===0?1:r===1?.68:.5,o=r===0?1:r===1?.55:0,s=r===0?5:r===1?3:1;n&&(e.style.transition=`none`),e.style.transform=`translateX(calc(-50% + ${i}px)) translateY(-50%) scale(${a})`,e.style.opacity=o,e.style.zIndex=s,n&&(e.offsetHeight,e.style.transition=``)}function o(t=!1){r.forEach((e,n)=>{a(i(e),n-2,t),i(e).classList.toggle(`cf-card--active`,n===2)}),e.querySelectorAll(`.cf-dot`).forEach((e,t)=>{e.classList.toggle(`active`,t===r[2])}),s()}function s(){let t=f[r[2]],n=p.find(e=>e.region===t.id&&e.format===`spray`),i=p.find(e=>e.region===t.id&&e.format===`oil`),a=e.querySelector(`#cf-info`),o=(e,t)=>`
      ...
      <div class="cf-info__inner" style="--rc: ${t.color}; --rcl: ${t.colorLight};">
        <div class="cf-info__top">
          ...
          <p class="cf-info__tagline">${t.tagline}</p>
        </div>
...
Respond in EXACTLY this JSON format (no markdown, no code blocks):
{
  ...
  `,document.head.appendChild(e)}var nf={scandinavian:new URL(`/mon_accord/assets/scandinavian-5ibAHdAH.png`,``+import.meta.url).href,eastasia:new URL(`/mon_accord/assets/east_asia-DZK4DeZe.png`,``+import.meta.url).href,southafrica:new URL(`/mon_accord/assets/south_africa-DwLt2ni5.png`,``+import.meta.url).href,mediterranean:new URL(`/mon_accord/assets/mediterranean-fZMNFcGl.png`,``+import.meta.url).href,southamerica:new URL(`/mon_accord/assets/south_america-PQykoay7.png`,``+import.meta.url).href,middleeast:new URL(`/mon_accord/assets/middle_east-DEEY7Abs.png`,``+import.meta.url).href},rf=`lab_session_state`;function af(e){try{sessionStorage.setItem(rf,JSON.stringify(e))}catch{}}function of(){try{return JSON.parse(sessionStorage.getItem(rf)||`null`)}catch{return null}}function sf(e,t){let n=of(),r=n?.layers||[],i=n?.scentSimulation||null,a=!1,o=n?.contextResult||null,s=!1,c=n?.selectedMood||null,l=n?.selectedOccasion||null,u=n?.selectedSeason||null,d=n?.selectedTime||null,p=n?.selectedIntensity||5;function m(){af({layers:r,scentSimulation:i,contextResult:o,selectedMood:c,selectedOccasion:l,selectedSeason:u,selectedTime:d,selectedIntensity:p})}let h=JSON.parse(sessionStorage.getItem(`labPending`)||`[]`);h.length>0&&(h.forEach(e=>{let t=v(e);t&&!r.find(t=>t.perfumeId===e)&&r.push({perfumeId:e,amount:t.format===`spray`?2:3,unit:t.format===`spray`?`sprays`:`drops`})}),sessionStorage.removeItem(`labPending`),m());function g(){e.innerHTML=`
      <div class="page__container">
                ...
                <div class="community-trending-item" data-id="${e.id}">
                  ...
                  <div class="community-trending-content">
                    ...
                    <div class="community-trending-layers">
                      ${(e.layers||[]).map(e=>{let t=v(e.perfumeId),n=t?f.find(e=>e.id===t.region):null;return`<span style="color: ${n?.color||`var(--text-tertiary)`};">${n?.icon||``} ${t?.name||``}</span>`}).join(` <span style="color: var(--text-tertiary);">+</span> `)}
                    </div>
                  </div>
          ...
          <div class="shop-cart">
            ...
            `:`
              <div class="shop-cart__items">
                ${a.map(e=>{let t=v(e.id),n=f.find(e=>e.id===t.region);return`
