...
`).filter(e=>e.trim()).map(e=>{if(e.match(/^(OPENING|HEART|DRY DOWN|OVERALL|SILLAGE)/i)){let[t,...n]=e.split(`:`);return`<p><strong style="color: var(--accent);">${t.trim()}:</strong> ${n.join(`:`).trim()}</p>`}return`<p>${e}</p>`}).join(``):``}function pf(){if(document.getElementById(`lab-styles`))return;let e=document.createElement(`style`);e.id=`lab-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e)}var mf=`/mon_accord/assets/folder-BRsxHk1w.png`,hf={scandinavian:new URL(`/mon_accord/assets/scandinavian-5ibAHdAH.png`,``+import.meta.url).href,eastasia:new URL(`/mon_accord/assets/east_asia-DZK4DeZe.png`,``+import.meta.url).href,southafrica:new URL(`/mon_accord/assets/south_africa-DwLt2ni5.png`,``+import.meta.url).href,mediterranean:new URL(`/mon_accord/assets/mediterranean-fZMNFcGl.png`,``+import.meta.url).href,southamerica:new URL(`/mon_accord/assets/south_america-PQykoay7.png`,``+import.meta.url).href,middleeast:new URL(`/mon_accord/assets/middle_east-DEEY7Abs.png`,``+import.meta.url).href},gf={scandinavian:new URL(`/mon_accord/assets/scandinavian-T91uXqs1.png`,``+import.meta.url).href,eastasia:new URL(`/mon_accord/assets/east_asia-C6p3o17-.png`,``+import.meta.url).href,southafrica:new URL(`/mon_accord/assets/south_africa-DqiVXp2O.png`,``+import.meta.url).href,mediterranean:new URL(`/mon_accord/assets/mediterranean-zaCtkOEY.png`,``+import.meta.url).href,southamerica:new URL(`/mon_accord/assets/south_america-BEKaFRIH.png`,``+import.meta.url).href,middleeast:new URL(`/mon_accord/assets/middle_east-Df_0XU0d.png`,``+import.meta.url).href},_f={},vf=[{id:`default`,name:`All Formulas`},{id:`evening`,name:`Evening Wear`},{id:`daytime`,name:`Daytime`},{id:`office`,name:`Office`},{id:`weekend`,name:`Weekend`},{id:`seasonal`,name:`Seasonal`}];function yf(e,t){let n=u.get(`vault_folders`,null),r;if(!n)r=vf.map(e=>({...e})),u.set(`vault_folders`,r);else{let e=new Set(n.map(e=>e.id)),t=vf.filter(t=>!e.has(t.id));t.length?(r=[...n,...t].map(e=>({id:e.id,name:e.name})),u.set(`vault_folders`,r)):r=n.map(e=>({id:e.id,name:e.name}))}let i=null,a=!1,o=null,s=null;function c(){u.set(`vault_folders`,r)}function l(e){let t=u.getVault();return e===`default`?t:t.filter(t=>t.folderId===e)}function d(){let t=u.getVault();e.innerHTML=`
    ...
    `}function g(){let e=u.getOwnedPerfumes();function t(e){return e.length?`<div class="vault-bottle-grid">
    ...
    `}function _(e,t){let n=l(e.id);return`
      ...
      `}
    `}function y(){if(!o)return``;let e=u.getOwnedPerfumes();if(o===`monAccord`)return`
...
Respond in EXACTLY this JSON format (no markdown, no code blocks):
{
  ...
  "scentDescription": "Vivid 2-sentence sensory preview"
            ...
            <div class="community-panel community-duygu-choice">
              ...
              <div class="duygu-card">
                <div class="duygu-card__photo-wrap">
                  <img src="${Tf}" alt="Duygu Özaslan" class="duygu-card__photo" />
                </div>
    ...
    `,Af(),te(t,n)}function C(e){let t=[...p.map(e=>({id:e.id,label:`${f.find(t=>t.id===e.region)?.icon||``} ${e.name} (${e.format})`,group:`Mon Accord`})),...h.map(e=>({id:e.id,label:`${e.brand} — ${e.name}`,group:`L'Oreal Luxe`}))];return`
  ...
  `:`<p style="font-size:var(--text-sm);color:var(--text-tertiary);padding:var(--space-lg);">No suggestion available.</p>`}function Af(){if(document.getElementById(`community-styles`))return;let e=document.createElement(`style`);e.id=`community-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e)}var jf=`/mon_accord/assets/Sephora-Logo-0PIDe1Np.png`,Mf=`/mon_accord/assets/Boyner_Logo-CHQxYmdT.jpg`,Nf=`/mon_accord/assets/Trendyol_logo-CfMQtlYm.png`,Pf=`/mon_accord/assets/hepsiburada-logo-I_Ul_zcU.png`;function Ff(e,t){let n=u.getShopCart(),r=[...new Set(u.consumePendingShopCart())],i=[...new Set([...n,...r])],a=i.map(e=>({id:e}));if(r.length){let e=i.length-n.length;window.showToast(`Added ${e} new item${e===1?``:`s`} from your recommended combination.`)}o();function o(){u.setShopCart(a.map(e=>e.id))}function s(){let n=u.getOwnedPerfumes().monAccord||[],r=If(n,a);e.innerHTML=`
      <div class="page__container">
        ...
        <div class="order-retailers">
          <div class="order-retailers__grid">
            <div class="order-retailer-card" aria-label="Sephora">
              <img src="${jf}" alt="Sephora" class="order-retailer-card__logo" />
            </div>
            <div class="order-retailer-card" aria-label="Boyner">
              <img src="${Mf}" alt="Boyner" class="order-retailer-card__logo" />
            </div>
            <div class="order-retailer-card" aria-label="Trendyol">
              <img src="${Nf}" alt="Trendyol" class="order-retailer-card__logo" />
            </div>
            <div class="order-retailer-card" aria-label="Hepsiburada">
              <img src="${Pf}" alt="Hepsiburada" class="order-retailer-card__logo" />
            </div>
          </div>
        </div>
  ...
  `,document.body.appendChild(e),document.getElementById(`dt-skip`).addEventListener(`click`,yp),document.getElementById(`dt-next`).addEventListener(`click`,()=>{clearTimeout(pp),clearInterval(lp),hp()})}function _p(){document.getElementById(`dt-card`)?.remove(),document.getElementById(`dt-flash`)?.remove()}function vp(){dp&&yp(),qf=window.location.hash||``,Jf=Bf(localStorage),Yf=Bf(sessionStorage),Xf=window.__retakeQuiz,localStorage.clear(),sessionStorage.clear(),delete window.__retakeQuiz,localStorage.removeItem(Gf),dp=!0,fp=0,gp(),mp(0)}function yp(){dp=!1,clearTimeout(pp),clearInterval(lp),Vf(localStorage,Jf),Vf(sessionStorage,Yf),Jf=null,Yf=null,Xf===void 0?delete window.__retakeQuiz:window.__retakeQuiz=Xf,Xf=void 0,(qf||``)!==(window.location.hash||``)&&(window.location.hash=qf||`#landing`),qf=``,_p()}function bp(){if(document.getElementById(`dt-styles`))return;let e=document.createElement(`style`);e.id=`dt-styles`,e.textContent=`
    #dt-card {
      position: fixed;
      z-index: 99995;
      top: 0;
  ...
  `,document.head.appendChild(e)}var xp=document.getElementById(`app`),Sp={"":x,"#landing":x,"#profile":Rd,"#lab":uf,"#vault":yf,"#shop":Ff,"#community":Of};function Cp(){return window.location.hash||``}function wp(e){window.location.hash=e}function Tp(){let e=Cp(),t=Sp[e]||x;xp.innerHTML=``,xp.appendChild(d(wp,e));let n=document.createElement(`div`);if(n.className=`page page-enter`,n.id=`page-content`,t(n,wp),xp.appendChild(n),!document.querySelector(`.toast-container`)){let e=document.createElement(`div`);e.className=`toast-container`,e.id=`toast-container`,document.body.appendChild(e)}window.scrollTo({top:0,behavior:`auto`})}window.showToast=function(e,t=`success`){let n=document.getElementById(`toast-container`);if(!n)return;let r=document.createElement(`div`);r.className=`toast toast--${t}`,r.innerHTML=`<span class="toast__message">${e}</span>`,n.appendChild(r),setTimeout(()=>{r.style.animation=`fadeOut 0.3s var(--ease-out) forwards`,setTimeout(()=>r.remove(),300)},3e3)},window.showSettings=function(){let e=document.querySelector(`.modal-overlay`);e&&e.remove();let t=document.createElement(`div`);t.className=`modal-overlay`,t.id=`settings-modal`,t.innerHTML=`
    <div class="modal">
      <div class="modal__header">
