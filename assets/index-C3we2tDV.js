var e=Object.create,t=Object.defineProperty,n=Object.getOwnPropertyDescriptor,r=Object.getOwnPropertyNames,i=Object.getPrototypeOf,a=Object.prototype.hasOwnProperty,o=(e,t)=>()=>(t||e((t={exports:{}}).exports,t),t.exports),s=(e,i,o,s)=>{if(i&&typeof i==`object`||typeof i==`function`)for(var c=r(i),l=0,u=c.length,d;l<u;l++)d=c[l],!a.call(e,d)&&d!==o&&t(e,d,{get:(e=>i[e]).bind(null,d),enumerable:!(s=n(i,d))||s.enumerable});return e},c=(n,r,a)=>(a=n==null?{}:e(i(n)),s(r||!n||!n.__esModule?t(a,`default`,{value:n,enumerable:!0}):a,n));(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var l=`monaccord_`,u={get(e,t=null){try{let n=localStorage.getItem(l+e);return n?JSON.parse(n):t}catch{return t}},set(e,t){try{localStorage.setItem(l+e,JSON.stringify(t))}catch(e){console.warn(`Storage write failed:`,e)}},remove(e){localStorage.removeItem(l+e)},getProfile(){return this.get(`profile`,null)},setProfile(e){this.set(`profile`,{...e,updatedAt:Date.now()})},getVault(){return this.get(`vault`,[])},saveFormula(e){let t=this.getVault(),n=t.findIndex(t=>t.id===e.id);return n>=0?t[n]={...e,savedAt:Date.now()}:t.push({...e,id:e.id||`f-`+Date.now(),savedAt:Date.now()}),this.set(`vault`,t),this.addInteraction({type:`save`,formulaId:e.id,timestamp:Date.now()}),t},removeFormula(e){let t=this.getVault().filter(t=>t.id!==e);return this.set(`vault`,t),t},getInteractions(){return this.get(`interactions`,[])},addInteraction(e){let t=this.getInteractions();t.push({...e,timestamp:e.timestamp||Date.now()}),t.length>500&&t.splice(0,t.length-500),this.set(`interactions`,t)},getLikes(){return this.get(`likes`,[])},toggleLike(e){let t=this.getLikes(),n=t.indexOf(e);return n>=0?(t.splice(n,1),this.addInteraction({type:`unlike`,formulaId:e,timestamp:Date.now()})):(t.push(e),this.addInteraction({type:`like`,formulaId:e,timestamp:Date.now()})),this.set(`likes`,t),t},isLiked(e){return this.getLikes().includes(e)},getOwnedPerfumes(){let e=this.get(`my_perfumes`,null);return Array.isArray(e)?{monAccord:e.map(e=>e.id),loreal:[]}:e||{monAccord:[],loreal:[]}},setOwnedPerfumes(e){this.set(`my_perfumes`,e)},getApiKey(){return this.get(`gemini_api_key`,``)},setApiKey(e){this.set(`gemini_api_key`,e)},getQuizState(){return this.get(`quiz_state`,null)},setQuizState(e){this.set(`quiz_state`,e)},clearQuizState(){this.remove(`quiz_state`)},setPendingShopCart(e){this.set(`pending_shop_cart`,e)},consumePendingShopCart(){let e=this.get(`pending_shop_cart`,[]);return this.remove(`pending_shop_cart`),Array.isArray(e)?e:[]},getShopCart(){let e=this.get(`shop_cart`,[]);return Array.isArray(e)?e:[]},setShopCart(e){this.set(`shop_cart`,e)},clearShopCart(){this.remove(`shop_cart`)},getUsername(){return this.getProfile()?.username||`Anonymous`},getPosts(){return this.get(`community_posts`,[])},setPosts(e){this.set(`community_posts`,e)},getPostLikes(){return this.get(`post_likes`,[])},togglePostLike(e){let t=this.getPostLikes(),n=t.indexOf(e);return n>=0?t.splice(n,1):t.push(e),this.set(`post_likes`,t),t},isPostLiked(e){return this.getPostLikes().includes(e)}};function d(e,t){let n=document.createElement(`nav`);return n.className=`navbar`,n.id=`main-nav`,u.getProfile(),n.innerHTML=`
          ...
          <div class="cf-stage" id="cf-stage">
            ${f.map((e,t)=>`
              <div class="cf-card" data-index="${t}" data-region="${e.id}">
                <img src="${y[e.id]}" alt="${e.name}" class="cf-card__img" draggable="false" />
              </div>
            `).join(``)}
          </div>
  ...
  `,x(),e.querySelector(`#scroll-hint`).addEventListener(`click`,()=>{document.getElementById(`origin-section`)?.scrollIntoView({behavior:`smooth`})}),e.querySelector(`#bottom-cta`).addEventListener(`click`,()=>{t(n?`#lab`:`#profile`)});let r=[0,1,2,3,4,5];function i(t){return e.querySelector(`.cf-card[data-index="${t}"]`)}function a(e,t,n=!1){let r=Math.abs(t),i=t*230,a=r===0?1:r===1?.68:.5,o=r===0?1:r===1?.55:0,s=r===0?5:r===1?3:1;n&&(e.style.transition=`none`),e.style.transform=`translateX(calc(-50% + ${i}px)) translateY(-50%) scale(${a})`,e.style.opacity=o,e.style.zIndex=s,n&&(e.offsetHeight,e.style.transition=``)}function o(t=!1){r.forEach((e,n)=>{a(i(e),n-2,t),i(e).classList.toggle(`cf-card--active`,n===2)}),e.querySelectorAll(`.cf-dot`).forEach((e,t)=>{e.classList.toggle(`active`,t===r[2])}),s()}function s(){let t=f[r[2]],n=p.find(e=>e.region===t.id&&e.format===`spray`),i=p.find(e=>e.region===t.id&&e.format===`oil`),a=e.querySelector(`#cf-info`),o=(e,t)=>`
...
Keep responses concise but rich. Use fragrance terminology naturally.`;function Td(){return u.getApiKey()}function Ed(){let e=Td();if(!e)return!1;try{return Cd=new Sd({apiKey:e}),!0}catch(e){return console.error(`Failed to initialize Gemini:`,e),!1}}async function Dd(e,t=2){if(!Cd&&!Ed())return{success:!1,error:`no-api-key`,text:`Please set your Gemini API key in Settings to enable AI features.`};try{let t=(await Cd.models.generateContent({model:`gemini-2.5-flash`,contents:e,config:{systemInstruction:wd}})).text;return t?{success:!0,text:t}:(console.error(`Empty response from Gemini`),{success:!1,error:`empty-response`,text:`AI returned an empty response. Please try again.`})}catch(n){let r=n.message||String(n);if(console.error(`AI generation error:`,r),r.includes(`429`)||r.includes(`quota`)||r.includes(`rate`)||r.includes(`RESOURCE_EXHAUSTED`)){let n=r.match(/retry in (\d+)/i)||r.match(/retryDelay.*?(\d+)/),i=n?parseInt(n[1]):30;return t>0?(console.log(`Rate limited. Waiting ${i}s before retry... (${t} retries left)`),await new Promise(e=>setTimeout(e,(i+2)*1e3)),Dd(e,t-1)):{success:!1,error:`rate-limit`,text:`Rate limit exceeded. The free tier has per-minute and daily limits. Please wait ${i} seconds and try again, or check your quota at ai.google.dev.`}}return r.includes(`API_KEY`)||r.includes(`API key`)||r.includes(`401`)||r.includes(`403`)?(Cd=null,{success:!1,error:`invalid-key`,text:`Invalid API key. Please check your Gemini API key in Settings.`}):r.includes(`fetch`)||r.includes(`network`)||r.includes(`ECONNREFUSED`)?{success:!1,error:`network`,text:`Network error. Please check your internet connection and try again.`}:{success:!1,error:`generation-failed`,text:`AI generation failed: ${r.slice(0,200)}`}}}function Od(){return!!Td()}async function kd(e){let t=await Dd(Ad(e));if(t.success){let n=jd(t.text,e);return u.setProfile(n),u.addInteraction({type:`profile-created`,profile:n.archetype}),{success:!0,profile:n}}return{success:!1,error:t.text}}function Ad(e){let t=e.scentFamilies?.join(`, `)||`not specified`,n=(e.knownPerfumes||[]).map(e=>{let t=h.find(t=>t.id===e);return t?`${t.brand} ${t.name} (${t.family})`:e}).join(`, `)||`none selected`,r=e.interestedRegions?.join(`, `)||`all regions`;return`Analyze this user's fragrance preferences and create their olfactory profile.
...
}`}function jd(e,t){try{let n=e.trim();return n.startsWith("```")&&(n=n.replace(/^```(?:json)?\n?/,``).replace(/\n?```$/,``)),{...JSON.parse(n),createdAt:Date.now(),quizAnswers:t}}catch(e){return console.error(`Failed to parse profile JSON:`,e),Md(t)}}function Md(e){let t=e.scentFamilies||[`woody`],n=`woody-earthy`;t.includes(`oriental`)||t.includes(`spicy`)?n=`warm-oriental`:t.includes(`fresh`)||t.includes(`citrus`)?n=`fresh-aquatic`:t.includes(`floral`)?n=`floral-romantic`:t.includes(`gourmand`)&&(n=`gourmand-cozy`);let r=_.find(e=>e.id===n)||_[0];return{archetype:n,archetypeName:r.name,description:r.description,primaryFamilies:t.slice(0,3),sillageProfile:e.sillage>7?`high`:e.sillage>4?`medium`:`low`,notePreferences:{loves:[],explore:[],avoid:[]},recommendedRegions:e.interestedRegions||[`mediterranean`,`eastasia`],signatureBlend:null,createdAt:Date.now(),quizAnswers:e}}async function Nd(e){return await Dd(`You are simulating the scent experience of this fragrance combination. Describe what the wearer would smell in three temporal phases.
...
Be poetic but precise. Help the reader "smell" this blend through words. Keep it under 200 words total.`)}var Pd=Object.fromEntries([`fresh`,`floral`,`woody`,`oriental`,`citrus`,`gourmand`,`green`,`aromatic`,`spicy`,`musky`].map(e=>[e,new URL(Object.assign({"../assets/quiz_scent_families/aromatic.png":S,"../assets/quiz_scent_families/citrus.png":C,"../assets/quiz_scent_families/floral.png":w,"../assets/quiz_scent_families/fresh.png":T,"../assets/quiz_scent_families/gourmand.png":E,"../assets/quiz_scent_families/green.png":D,"../assets/quiz_scent_families/musky.png":O,"../assets/quiz_scent_families/oriental.png":k,"../assets/quiz_scent_families/spicy.png":A,"../assets/quiz_scent_families/woody.png":ee})[`../assets/quiz_scent_families/${e}.png`],import.meta.url).href])),Fd={elegant:new URL(`/mon_accord/assets/elegant_classic-DRER5jBh.png`,``+import.meta.url).href,adventurous:new URL(`/mon_accord/assets/adventurous_bold-SjNP7L-r.png`,``+import.meta.url).href,romantic:new URL(`/mon_accord/assets/romantic_dreamy-CLUpTJmt.png`,``+import.meta.url).href,minimalist:new URL(`/mon_accord/assets/minimalist_clean-BrPXV53H.png`,``+import.meta.url).href,creative:new URL(`/mon_accord/assets/creative_expressive-Cd5TtKJD.png`,``+import.meta.url).href,confident:new URL(`/mon_accord/assets/confident_powerful-w73bkLNN.png`,``+import.meta.url).href},Id=5;function Ld(e,t){let n=u.getProfile();if(n&&!window.__retakeQuiz){Kd(e,n,t);return}window.__retakeQuiz=!1;let r=u.getQuizState(),i=r?.step||1,a=r?.answers||{username:``,scentFamilies:[],knownPerfumes:[],sillage:5,longevity:5,intensity:5,personality:``,notes:``};function o(){u.setQuizState({step:i,answers:a}),e.innerHTML=`
      <div class="page__container">
        <div class="quiz-container">
          <div class="quiz-stepper">
            ${Array.from({length:Id},(e,t)=>{let n=t+1,r=n<i?`completed`:n===i?`active`:``,a=n<i?`done`:``;return`<div class="quiz-stepper__item ${r}"><div class="quiz-stepper__circle">${n<i?`✓`:String(n)}</div></div>${t<Id-1?`<div class="quiz-stepper__line ${a}"></div>`:``}`}).join(``)}
          </div>
          ...
          <div class="quiz-actions">
            ...
            ${i<Id?`<button class="btn btn--primary" id="quiz-next">Continue →</button>`:`<button class="btn btn--primary" id="quiz-finish">
                  ${Od()?`✦ Generate My Profile`:`✦ Generate Profile`}
                </button>`}
          </div>
        </div>
      </div>
    `,qd(),Bd(i,a,e);let n=e.querySelector(`#quiz-back`),r=e.querySelector(`#quiz-next`),s=e.querySelector(`#quiz-finish`);n&&n.addEventListener(`click`,()=>{Vd(i,a,e),i--,o()}),r&&r.addEventListener(`click`,()=>{Vd(i,a,e),i++,o()}),s&&s.addEventListener(`click`,async()=>{if(Vd(i,a,e),!Od()){window.showToast(`Please set your Gemini API key in Settings first.`,`error`),window.showSettings();return}s.disabled=!0,s.innerHTML=`<span class="loading-spinner"></span> Generating...`;let n=e.querySelector(`#generation-status`);n||(n=document.createElement(`p`),n.id=`generation-status`,n.style.cssText=`font-size: var(--text-xs); color: var(--text-tertiary); text-align: center; margin-top: var(--space-sm);`,s.parentElement.appendChild(n)),n.textContent=`Analyzing your preferences with AI...`;let r=await kd(a);r.success?(r.profile.username=a.username||`Anonymous`,u.setProfile(r.profile),u.clearQuizState(),Hd(e,r.profile,t),window.showToast(`Your olfactory profile has been created! ✦`)):(s.disabled=!1,s.innerHTML=`✦ Generate My Profile`,n.textContent=``,window.showToast(r.error||`Failed to generate profile.`,`error`))})}o()}function Rd(e,t){switch(e){case 1:return`
        ...
        <div class="quiz-grid quiz-grid--families">
          ${m.map(e=>`
            <div class="quiz-option quiz-option--img-card ${t.scentFamilies.includes(e.id)?`quiz-option--selected`:``}" data-value="${e.id}" id="family-${e.id}">
              <img class="quiz-option__img" src="${Pd[e.id]}" alt="${e.name}" />
            </div>
          `).join(``)}
        </div>
      `;case 3:return`
      ...
      `}}function zd(e,t){let n=t?h.filter(e=>e.name.toLowerCase().includes(t.toLowerCase())||e.brand.toLowerCase().includes(t.toLowerCase())):h,r={};return n.forEach(e=>{r[e.brand]||(r[e.brand]=[]),r[e.brand].push(e)}),Object.entries(r).map(([t,n])=>`
      ...
      <div class="profile-result">
        ...
        <div class="mt-xl">
          ...
          <div class="recommendation-grid">
            ${r.map(e=>Ud(e,{showBuyButton:!0})).join(``)}
          </div>
        </div>
  ...
  `,qd(),e.querySelector(`#go-to-shop`).addEventListener(`click`,()=>n(`#shop`)),e.querySelectorAll(`[data-buy-combo]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.comboIds.split(`,`).map(e=>e.trim()).filter(Boolean);u.setPendingShopCart(t),n(`#shop`)})}),e.querySelector(`#go-to-lab`).addEventListener(`click`,()=>n(`#lab`)),e.querySelector(`#retake-quiz`).addEventListener(`click`,()=>{window.__retakeQuiz=!0,u.clearQuizState(),Ld(e,n)})}function Ud(e,t={}){let n=(e.productIds||[]).join(`,`);return`
  ...
  `,document.head.appendChild(e)}var Jd=[{id:`confident`,name:`Confident`,icon:``,description:`Bold and commanding`},{id:`romantic`,name:`Romantic`,icon:``,description:`Soft and alluring`},{id:`calm`,name:`Calm`,icon:``,description:`Peaceful and centered`},{id:`energetic`,name:`Energetic`,icon:``,description:`Vibrant and lively`},{id:`mysterious`,name:`Mysterious`,icon:``,description:`Enigmatic and deep`},{id:`playful`,name:`Playful`,icon:``,description:`Light and fun`}],Yd=[{id:`office`,name:`Office / Work`,icon:``},{id:`date-night`,name:`Date Night`,icon:``},{id:`casual`,name:`Casual Outing`,icon:``},{id:`formal`,name:`Formal Event`,icon:``},{id:`outdoor`,name:`Outdoor Adventure`,icon:``},{id:`cozy`,name:`Cozy Night In`,icon:``}],Xd=[{id:`spring`,name:`Spring`,icon:``},{id:`summer`,name:`Summer`,icon:``},{id:`autumn`,name:`Autumn`,icon:``},{id:`winter`,name:`Winter`,icon:``}],Zd=[{id:`whisper`,name:`Whisper`,value:1,description:`Barely there, intimate`},{id:`soft`,name:`Soft`,value:3,description:`Close range only`},{id:`moderate`,name:`Moderate`,value:5,description:`Noticeable arm's length`},{id:`present`,name:`Present`,value:7,description:`Fills the room gently`},{id:`bold`,name:`Bold`,value:9,description:`Leaves a trail`}];function Qd(){let e=u.getOwnedPerfumes(),t=[];if(e.monAccord?.length){let n=e.monAccord.map(e=>p.find(t=>t.id===e)?.name).filter(Boolean);n.length&&t.push(`Mon Accord owned: ${n.join(`, `)}`)}if(e.loreal?.length){let n=e.loreal.map(e=>h.find(t=>t.id===e)?.name).filter(Boolean);n.length&&t.push(`L'Oréal Luxe owned: ${n.join(`, `)}`)}return t.length?t.join(`
`):null}async function $d(e){let t=u.getProfile(),n=Qd(),r=await Dd(`Based on the user's context, recommend a Mon Accord layering formula.
...
Respond in EXACTLY this JSON format (no markdown, no code blocks):
{
...
}`);if(r.success)try{let t=r.text.trim();t.startsWith("```")&&(t=t.replace(/^```(?:json)?\n?/,``).replace(/\n?```$/,``));let n=JSON.parse(t);return u.addInteraction({type:`contextual-recommendation`,context:e,recommendation:n.formulaName}),{success:!0,recommendation:n}}catch(e){return console.error(`Failed to parse recommendation:`,e),{success:!0,recommendation:{formulaName:`AI Recommendation`,layers:[],reasoning:r.text,scentPreview:``,tips:``}}}return{success:!1,error:r.text}}function ef(e,t={}){let{showNameInput:n=!0,onSaved:r}=t,i=u.get(`vault_folders`,[{id:`default`,name:`All Formulas`,icon:``}]),a=`default`,o=!1;function s(){let t=document.getElementById(`save-vault-overlay`);t&&t.remove();let c=document.createElement(`div`);c.className=`modal-overlay`,c.id=`save-vault-overlay`,c.innerHTML=`
  ...
  `,document.head.appendChild(e)}var nf={scandinavian:new URL(`../assets/scandinavian.png`,``+import.meta.url).href,eastasia:new URL(`../assets/east_asia.png`,``+import.meta.url).href,southafrica:new URL(`../assets/south_africa.png`,``+import.meta.url).href,mediterranean:new URL(`../assets/mediterranean.png`,``+import.meta.url).href,southamerica:new URL(`../assets/south_america.png`,``+import.meta.url).href,middleeast:new URL(`../assets/middle_east.png`,``+import.meta.url).href},rf=`lab_session_state`;function af(e){try{sessionStorage.setItem(rf,JSON.stringify(e))}catch{}}function of(){try{return JSON.parse(sessionStorage.getItem(rf)||`null`)}catch{return null}}function sf(e,t){let n=of(),r=n?.layers||[],i=n?.scentSimulation||null,a=!1,o=n?.contextResult||null,s=!1,c=n?.selectedMood||null,l=n?.selectedOccasion||null,u=n?.selectedSeason||null,d=n?.selectedTime||null,p=n?.selectedIntensity||5;function m(){af({layers:r,scentSimulation:i,contextResult:o,selectedMood:c,selectedOccasion:l,selectedSeason:u,selectedTime:d,selectedIntensity:p})}let h=JSON.parse(sessionStorage.getItem(`labPending`)||`[]`);h.length>0&&(h.forEach(e=>{let t=v(e);t&&!r.find(t=>t.perfumeId===e)&&r.push({perfumeId:e,amount:t.format===`spray`?2:3,unit:t.format===`spray`?`sprays`:`drops`})}),sessionStorage.removeItem(`labPending`),m());function g(){e.innerHTML=`
      <div class="page__container">
                ...
                ${f.map(e=>`
                  <div class="lab-region-group" style="--region-color: ${e.color};">
                    <div class="lab-region-layout">
                      <img class="lab-region-img" src="${nf[e.id]}" alt="${e.name}" />
                      <div class="lab-region-right">
                        <p class="lab-region-label">${e.name}</p>
                        <div class="lab-region-items">
                          ${cf(e.id).map(t=>{let n=r.find(e=>e.perfumeId===t.id);return`
                              <button class="lab-add-btn ${n?`lab-add-btn--added`:``}" data-id="${t.id}" style="--region-color: ${e.color};">
                                <span class="lab-format-badge lab-format-badge--${t.format}">${t.format===`spray`?`SPRAY`:`OIL`}</span>
                                <span class="lab-add-btn__indicator">${n?`✓`:`+`}</span>
                              </button>
                            `}).join(``)}
                        </div>
                      </div>
              ...
              <div class="lab-advisor__form">
                <div class="input-group">
                  ...
                  <div class="lab-advisor__chips" id="mood-chips">
                    ${Jd.map(e=>`<button class="lab-chip ${c===e.id?`lab-chip--active`:``}" data-value="${e.id}">${e.icon} ${e.name}</button>`).join(``)}
                  </div>
                </div>
                ...
                <div class="input-group">
                  ...
                  <div class="lab-advisor__chips" id="occasion-chips">
                    ${Yd.map(e=>`<button class="lab-chip ${l===e.id?`lab-chip--active`:``}" data-value="${e.id}">${e.icon} ${e.name}</button>`).join(``)}
                  </div>
                </div>
                ...
                <div class="input-group">
                  ...
                  <div class="lab-advisor__chips" id="season-chips">
                    ${Xd.map(e=>`<button class="lab-chip ${u===e.id?`lab-chip--active`:``}" data-value="${e.id}">${e.icon} ${e.name}</button>`).join(``)}
                  </div>
                </div>
                ...
                <div class="slider-container">
                  <div class="slider-header">
                    <span class="slider-label">Intensity</span>
                    <span class="slider-value" id="advisor-intensity-val">${(Zd.find(e=>e.value===p)||{}).name||`Moderate`}</span>
                  </div>
                  <input type="range" min="1" max="9" value="${p}" step="2" id="advisor-intensity" />
                </div>
                ...
                <div class="lab-advisor__result mt-lg" id="advisor-result">
                  <div class="ai-response">
                    ...
                    <div class="ai-response__text ai-response__text--compact">
                      ${o.reasoning?`<p>${lf(o.reasoning,150)}</p>`:``}
                      ${o.scentPreview?`<p><em>${lf(o.scentPreview,100)}</em></p>`:``}
                      ${o.tips?`<p style="color: var(--accent); font-size: var(--text-xs);">◈ ${lf(o.tips,100)}</p>`:``}
                    </div>
                  </div>
                  ${o.layers?.length>0?`
                  ...
                  <div class="lab-layer" data-idx="${t}" style="--region-color: ${r.color};">
                    <div class="lab-layer__header">
                      <div class="lab-layer__identity">
                        ...
                        <span class="lab-format-badge lab-format-badge--${n.format}">${n.format===`spray`?`SPRAY`:`OIL`}</span>
                      </div>
    ...
    `,df(),_()}function _(){e.querySelectorAll(`.lab-add-btn`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.id,n=r.findIndex(e=>e.perfumeId===t);if(n>=0)r.splice(n,1);else{let e=v(t);r.push({perfumeId:t,amount:e.format===`spray`?2:3,unit:e.format===`spray`?`sprays`:`drops`})}i=null,m(),g()})}),e.querySelectorAll(`.lab-layer__remove`).forEach(e=>{e.addEventListener(`click`,t=>{t.stopPropagation(),r.splice(parseInt(e.dataset.idx),1),i=null,m(),g()})}),e.querySelectorAll(`.lab-layer__amount-btn`).forEach(e=>{e.addEventListener(`click`,t=>{t.stopPropagation();let n=parseInt(e.dataset.idx);e.dataset.action===`increase`?r[n].amount=Math.min(r[n].amount+1,10):r[n].amount=Math.max(r[n].amount-1,1),m(),g()})});let t=e.querySelector(`#btn-simulate`);t&&t.addEventListener(`click`,async()=>{if(!Od()){window.showToast(`Please set your Gemini API key in Settings.`,`error`),window.showSettings();return}a=!0,g();let e=await Nd(r);a=!1,e.success?(i=e.text,m()):window.showToast(e.text||`Simulation failed.`,`error`),g()});let n=e.querySelector(`#btn-save-formula`);n&&n.addEventListener(`click`,()=>{y(r,i)});let f=e.querySelector(`#btn-clear-layers`);f&&f.addEventListener(`click`,()=>{r=[],i=null,m(),g()}),[`mood`,`occasion`,`season`,`time`].forEach(t=>{e.querySelectorAll(`#${t}-chips .lab-chip`).forEach(n=>{n.addEventListener(`click`,()=>{e.querySelectorAll(`#${t}-chips .lab-chip`).forEach(e=>e.classList.remove(`lab-chip--active`)),n.classList.add(`lab-chip--active`);let r=n.dataset.value;t===`mood`?c=r:t===`occasion`?l=r:t===`season`?u=r:t===`time`&&(d=r),m()})})});let h=e.querySelector(`#advisor-intensity`);h&&h.addEventListener(`input`,()=>{p=parseInt(h.value);let t=Zd.find(e=>e.value===p);e.querySelector(`#advisor-intensity-val`).textContent=t?.name||`Moderate`,m()});let _=e.querySelector(`#btn-get-advice`);_&&_.addEventListener(`click`,async()=>{if(!Od()){window.showToast(`Please set your Gemini API key in Settings.`,`error`),window.showSettings();return}let t=e.querySelector(`#mood-chips .lab-chip--active`)?.dataset.value,n=e.querySelector(`#occasion-chips .lab-chip--active`)?.dataset.value,r=e.querySelector(`#season-chips .lab-chip--active`)?.dataset.value,i=e.querySelector(`#time-chips .lab-chip--active`)?.dataset.value,a=Zd.find(t=>t.value===parseInt(e.querySelector(`#advisor-intensity`)?.value||5))?.name||`moderate`;s=!0,g();let c=await $d({mood:t,occasion:n,season:r,timeOfDay:i,intensity:a});s=!1,c.success?(o=c.recommendation,m()):window.showToast(c.error||`Advice failed.`,`error`),g()});let b=e.querySelector(`#btn-apply-recommendation`);b&&b.addEventListener(`click`,()=>{o?.layers&&(r=o.layers.map(e=>({perfumeId:e.perfumeId,amount:e.amount,unit:e.unit||(e.perfumeId.includes(`oil`)?`drops`:`sprays`)})).filter(e=>v(e.perfumeId)),i=null,m(),g(),window.showToast(`Formula applied! Try simulating the scent.`))})}function y(e,t){let n=e.map(e=>{let t=v(e.perfumeId);return{...e,name:t?.name||e.perfumeId}});ef({id:`f-`+Date.now(),layers:n,simulation:t,createdAt:Date.now()},{showNameInput:!0})}g()}function cf(e){return p.filter(t=>t.region===e)}function lf(e,t=150){return!e||e.length<=t?e:e.substring(0,t).replace(/\s+\S*$/,``)+`…`}function uf(e){return e?e.split(`
`).filter(e=>e.trim()).map(e=>{if(e.match(/^(OPENING|HEART|DRY DOWN|OVERALL|SILLAGE)/i)){let[t,...n]=e.split(`:`);return`<p><strong style="color: var(--accent);">${t.trim()}:</strong> ${n.join(`:`).trim()}</p>`}return`<p>${e}</p>`}).join(``):``}function df(){if(document.getElementById(`lab-styles`))return;let e=document.createElement(`style`);e.id=`lab-styles`,e.textContent=`
    /* ── Page Header ── */
    .lab-page-header {
      text-align: center;
  ...
  `,document.head.appendChild(e)}var ff=`/mon_accord/assets/open-folder-BdwKQCux.png`,pf=[{id:`default`,name:`All Formulas`},{id:`evening`,name:`Evening Wear`},{id:`daytime`,name:`Daytime`},{id:`office`,name:`Office`},{id:`weekend`,name:`Weekend`},{id:`seasonal`,name:`Seasonal`}];function mf(e,t){let n=u.get(`vault_folders`,null),r;if(!n)r=pf.map(e=>({...e})),u.set(`vault_folders`,r);else{let e=new Set(n.map(e=>e.id)),t=pf.filter(t=>!e.has(t.id));t.length?(r=[...n,...t].map(e=>({id:e.id,name:e.name})),u.set(`vault_folders`,r)):r=n.map(e=>({id:e.id,name:e.name}))}let i=null,a=!1,o=null,s=null;function c(){u.set(`vault_folders`,r)}function l(e){let t=u.getVault();return e===`default`?t:t.filter(t=>t.folderId===e)}function d(){let t=u.getVault();e.innerHTML=`
      <div class="page__container">
        ${i?y(i,t):m(t)}
      </div>
      ${b()}
    `,hf(),x(t)}function m(e){return`
          ...
          <div class="vault-folders-grid">
            ${r.map(e=>{let t=l(e.id).length;return`
                <div class="vault-folder-card card card--interactive" data-folder="${e.id}">
                  <img src="${ff}" class="vault-folder-icon" alt="folder" />
...
Respond in EXACTLY this JSON format (no markdown, no code blocks):
{
  ...
  "scentDescription": "Vivid 2-sentence sensory preview"
            ...
            <div class="community-panel community-duygu-choice">
              ...
              <div class="duygu-card">
                <div class="duygu-card__photo-wrap">
                  <img src="${bf}" alt="Duygu Özaslan" class="duygu-card__photo" />
                </div>
    ...
    `,Tf(),te(t,n)}function C(e){let t=[...p.map(e=>({id:e.id,label:`${f.find(t=>t.id===e.region)?.icon||``} ${e.name} (${e.format})`,group:`Mon Accord`})),...h.map(e=>({id:e.id,label:`${e.brand} — ${e.name}`,group:`L'Oreal Luxe`}))];return`
  ...
  `:`<p style="font-size:var(--text-sm);color:var(--text-tertiary);padding:var(--space-lg);">No suggestion available.</p>`}function Tf(){if(document.getElementById(`community-styles`))return;let e=document.createElement(`style`);e.id=`community-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e)}var Ef=`/mon_accord/assets/Sephora-Logo-0PIDe1Np.png`,Df=`/mon_accord/assets/Boyner_Logo-CHQxYmdT.jpg`,Of=`/mon_accord/assets/Trendyol_logo-CfMQtlYm.png`,kf=`/mon_accord/assets/hepsiburada-logo-I_Ul_zcU.png`;function Af(e,t){let n=u.getShopCart(),r=[...new Set(u.consumePendingShopCart())],i=[...new Set([...n,...r])],a=i.map(e=>({id:e}));if(r.length){let e=i.length-n.length;window.showToast(`Added ${e} new item${e===1?``:`s`} from your recommended combination.`)}o();function o(){u.setShopCart(a.map(e=>e.id))}function s(){let n=u.getOwnedPerfumes().monAccord||[],r=jf(n,a);e.innerHTML=`
      <div class="page__container">
        ...
        <div class="order-retailers">
          <div class="order-retailers__grid">
            <div class="order-retailer-card" aria-label="Sephora">
              <img src="${Ef}" alt="Sephora" class="order-retailer-card__logo" />
            </div>
            <div class="order-retailer-card" aria-label="Boyner">
              <img src="${Df}" alt="Boyner" class="order-retailer-card__logo" />
            </div>
            <div class="order-retailer-card" aria-label="Trendyol">
              <img src="${Of}" alt="Trendyol" class="order-retailer-card__logo" />
            </div>
            <div class="order-retailer-card" aria-label="Hepsiburada">
              <img src="${kf}" alt="Hepsiburada" class="order-retailer-card__logo" />
            </div>
          </div>
        </div>
  ...
  `,document.body.appendChild(e),document.getElementById(`dt-skip`).addEventListener(`click`,mp),document.getElementById(`dt-next`).addEventListener(`click`,()=>{clearTimeout(cp),clearInterval(ip),up()})}function fp(){document.getElementById(`dt-card`)?.remove(),document.getElementById(`dt-flash`)?.remove()}function pp(){op&&mp(),Hf=window.location.hash||``,Uf=Ff(localStorage),Wf=Ff(sessionStorage),Gf=window.__retakeQuiz,localStorage.clear(),sessionStorage.clear(),delete window.__retakeQuiz,localStorage.removeItem(Bf),op=!0,sp=0,dp(),lp(0)}function mp(){op=!1,clearTimeout(cp),clearInterval(ip),If(localStorage,Uf),If(sessionStorage,Wf),Uf=null,Wf=null,Gf===void 0?delete window.__retakeQuiz:window.__retakeQuiz=Gf,Gf=void 0,(Hf||``)!==(window.location.hash||``)&&(window.location.hash=Hf||`#landing`),Hf=``,fp()}function hp(){if(document.getElementById(`dt-styles`))return;let e=document.createElement(`style`);e.id=`dt-styles`,e.textContent=`
    #dt-card {
      position: fixed;
      z-index: 99995;
      top: 0;
  ...
  `,document.head.appendChild(e)}var gp=document.getElementById(`app`),_p={"":b,"#landing":b,"#profile":Ld,"#lab":sf,"#vault":mf,"#shop":Af,"#community":Cf};function vp(){return window.location.hash||``}function yp(e){window.location.hash=e}function bp(){let e=vp(),t=_p[e]||b;gp.innerHTML=``,gp.appendChild(d(yp,e));let n=document.createElement(`div`);if(n.className=`page page-enter`,n.id=`page-content`,t(n,yp),gp.appendChild(n),!document.querySelector(`.toast-container`)){let e=document.createElement(`div`);e.className=`toast-container`,e.id=`toast-container`,document.body.appendChild(e)}window.scrollTo({top:0,behavior:`auto`})}window.showToast=function(e,t=`success`){let n=document.getElementById(`toast-container`);if(!n)return;let r=document.createElement(`div`);r.className=`toast toast--${t}`,r.innerHTML=`<span class="toast__message">${e}</span>`,n.appendChild(r),setTimeout(()=>{r.style.animation=`fadeOut 0.3s var(--ease-out) forwards`,setTimeout(()=>r.remove(),300)},3e3)},window.showSettings=function(){let e=document.querySelector(`.modal-overlay`);e&&e.remove();let t=document.createElement(`div`);t.className=`modal-overlay`,t.id=`settings-modal`,t.innerHTML=`
    <div class="modal">
      <div class="modal__header">
