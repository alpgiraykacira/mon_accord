...
Respond in EXACTLY this JSON format (no markdown, no code blocks):
{
  ...
  "scentDescription": "Vivid 2-sentence sensory preview"
            ...
            <div class="community-panel community-duygu-choice">
              ...
              <div class="duygu-card">
                <div class="duygu-card__photo-wrap">
                  <img src="${Ef}" alt="Duygu Özaslan" class="duygu-card__photo" />
                </div>
    ...
    `,jf(),te(t,n)}function C(e){let t=[...p.map(e=>({id:e.id,label:`${f.find(t=>t.id===e.region)?.icon||``} ${e.name} (${e.format})`,group:`Mon Accord`})),...h.map(e=>({id:e.id,label:`${e.brand} — ${e.name}`,group:`L'Oreal Luxe`}))];return`
