...
Be poetic but concise. One vivid idea per section. No extra headings or commentary.`,2,300)}var le=Object.fromEntries([`fresh`,`floral`,`woody`,`oriental`,`citrus`,`gourmand`,`green`,`aromatic`,`spicy`,`musky`].map(e=>[e,new URL(Object.assign({"../assets/quiz_scent_families_v2/aromatic.png":m,"../assets/quiz_scent_families_v2/citrus.png":h,"../assets/quiz_scent_families_v2/floral.png":g,"../assets/quiz_scent_families_v2/fresh.png":_,"../assets/quiz_scent_families_v2/gourmand.png":v,"../assets/quiz_scent_families_v2/green.png":y,"../assets/quiz_scent_families_v2/musky.png":b,"../assets/quiz_scent_families_v2/oriental.png":x,"../assets/quiz_scent_families_v2/spicy.png":S,"../assets/quiz_scent_families_v2/woody.png":ee})[`../assets/quiz_scent_families_v2/${e}.png`],import.meta.url).href])),ue={elegant:new URL(`/mon_accord/assets/elegant_classic-BiRAW1Ly.png`,``+import.meta.url).href,adventurous:new URL(`/mon_accord/assets/adventurous_bold-Bz6pRBer.png`,``+import.meta.url).href,romantic:new URL(`/mon_accord/assets/romantic_dreamy-CNzM-gWm.png`,``+import.meta.url).href,minimalist:new URL(`/mon_accord/assets/minimalist_clean-Dr7j3KT0.png`,``+import.meta.url).href,creative:new URL(`/mon_accord/assets/creative_expressive-D6akHWmL.png`,``+import.meta.url).href,confident:new URL(`/mon_accord/assets/confident_powerful-Bas-bCGv.png`,``+import.meta.url).href},de=5;function fe(e,n){let r=t.getProfile();if(r&&!window.__retakeQuiz){be(e,r,n);return}window.__retakeQuiz=!1;let i=t.getQuizState(),a=i?.step||1,o=i?.answers||{username:``,scentFamilies:[],knownPerfumes:[],sillage:5,longevity:5,intensity:5,personality:``,notes:``};function s(){t.setQuizState({step:a,answers:o}),e.innerHTML=`
    ...
    `,xe(),he(a,o,e);let r=e.querySelector(`#quiz-back`),i=e.querySelector(`#quiz-next`),c=e.querySelector(`#quiz-finish`);r&&r.addEventListener(`click`,()=>{M(a,o,e),a--,s()}),i&&i.addEventListener(`click`,()=>{M(a,o,e),a++,s()}),c&&c.addEventListener(`click`,async()=>{if(M(a,o,e),!A()){window.showToast(`Please set your Gemini API key in Settings first.`,`error`),window.showSettings();return}c.disabled=!0,c.innerHTML=`<span class="loading-spinner"></span> Generating...`;let r=e.querySelector(`#generation-status`);r||(r=document.createElement(`p`),r.id=`generation-status`,r.style.cssText=`font-size: var(--text-xs); color: var(--text-tertiary); text-align: center; margin-top: var(--space-sm);`,c.parentElement.appendChild(r)),r.textContent=`Analysing your preferences...`;let i=await j(o);i.success?(i.profile.username=o.username||`Anonymous`,t.setProfile(i.profile),t.clearQuizState(),ge(e,i.profile,n),window.showToast(`Your olfactory profile has been created! ✦`)):(c.disabled=!1,c.innerHTML=`✦ Generate My Profile`,r.textContent=``,window.showToast(i.error||`Failed to generate profile.`,`error`))})}s()}function pe(e,t){switch(e){case 1:return`
      ...
      <div class="profile-result">
        ...
        <div class="mt-xl">
          ...
          <div class="recommendation-grid">
            ${i.map(e=>_e(e,{showBuyButton:!0})).join(``)}
          </div>
        </div>
  ...
  `,document.head.appendChild(e)}var Se=[{id:`confident`,name:`Confident`,icon:``,description:`Bold and commanding`},{id:`romantic`,name:`Romantic`,icon:``,description:`Soft and alluring`},{id:`calm`,name:`Calm`,icon:``,description:`Peaceful and centered`},{id:`energetic`,name:`Energetic`,icon:``,description:`Vibrant and lively`},{id:`mysterious`,name:`Mysterious`,icon:``,description:`Enigmatic and deep`},{id:`playful`,name:`Playful`,icon:``,description:`Light and fun`}],Ce=[{id:`office`,name:`Office / Work`,icon:``},{id:`date-night`,name:`Date Night`,icon:``},{id:`casual`,name:`Casual Outing`,icon:``},{id:`formal`,name:`Formal Event`,icon:``},{id:`outdoor`,name:`Outdoor Adventure`,icon:``},{id:`cozy`,name:`Cozy Night In`,icon:``}],we=[{id:`spring`,name:`Spring`,icon:``},{id:`summer`,name:`Summer`,icon:``},{id:`autumn`,name:`Autumn`,icon:``},{id:`winter`,name:`Winter`,icon:``}],N=[{id:`whisper`,name:`Whisper`,value:1,description:`Barely there, intimate`},{id:`soft`,name:`Soft`,value:3,description:`Close range only`},{id:`moderate`,name:`Moderate`,value:5,description:`Noticeable arm's length`},{id:`present`,name:`Present`,value:7,description:`Fills the room gently`},{id:`bold`,name:`Bold`,value:9,description:`Leaves a trail`}];function Te(){let e=t.getOwnedPerfumes(),n=[];if(e.monAccord?.length){let t=e.monAccord.map(e=>i.find(t=>t.id===e)?.name).filter(Boolean);t.length&&n.push(`Mon Accord owned: ${t.join(`, `)}`)}if(e.loreal?.length){let t=e.loreal.map(e=>o.find(t=>t.id===e)?.name).filter(Boolean);t.length&&n.push(`L'Oréal Luxe owned: ${t.join(`, `)}`)}return n.length?n.join(`
`):null}async function Ee(e){let n=t.getProfile(),r=Te(),a=await k(`Based on the user's context, recommend a Mon Accord layering formula.
...
Respond in EXACTLY this JSON format (no markdown, no code blocks):
{
  ...
  `,document.head.appendChild(e)}var ke={scandinavian:new URL(`/mon_accord/assets/scandinavian-BN4U9Git.webp`,``+import.meta.url).href,eastasia:new URL(`/mon_accord/assets/east_asia-CIRqjWhL.webp`,``+import.meta.url).href,southafrica:new URL(`/mon_accord/assets/south_africa-BeRUDnKj.webp`,``+import.meta.url).href,mediterranean:new URL(`/mon_accord/assets/mediterranean-v1NGrAPJ.webp`,``+import.meta.url).href,southamerica:new URL(`/mon_accord/assets/south_america-DEpvED0s.webp`,``+import.meta.url).href,middleeast:new URL(`/mon_accord/assets/middle_east-DE6yO7Qz.webp`,``+import.meta.url).href},Ae={scandinavian:new URL(`/mon_accord/assets/scandinavian-DvtLirp4.webp`,``+import.meta.url).href,eastasia:new URL(`/mon_accord/assets/east_asia-UzXNmAB4.webp`,``+import.meta.url).href,southafrica:new URL(`/mon_accord/assets/south_africa-PFpjigF9.webp`,``+import.meta.url).href,mediterranean:new URL(`/mon_accord/assets/mediterranean-CV0fuGZk.webp`,``+import.meta.url).href,southamerica:new URL(`/mon_accord/assets/south_america-DyzbduD3.webp`,``+import.meta.url).href,middleeast:new URL(`/mon_accord/assets/middle_east-Bmlf8LlT.webp`,``+import.meta.url).href},je={scandinavian:new URL(`/mon_accord/assets/scandinavian-BBoj4W5D.webp`,``+import.meta.url).href,eastasia:new URL(`/mon_accord/assets/east_asia-D93RVLet.webp`,``+import.meta.url).href,southafrica:new URL(`/mon_accord/assets/south_africa-hdHFYwXs.webp`,``+import.meta.url).href,mediterranean:new URL(`/mon_accord/assets/mediterranean-B_fMAvaC.webp`,``+import.meta.url).href,southamerica:new URL(`/mon_accord/assets/south_america-DcR51yl4.webp`,``+import.meta.url).href,middleeast:new URL(`/mon_accord/assets/middle_east-DMI8-64c.webp`,``+import.meta.url).href},Me=`lab_session_state`;function Ne(e){try{sessionStorage.setItem(Me,JSON.stringify(e))}catch{}}function Pe(){try{return JSON.parse(sessionStorage.getItem(Me)||`null`)}catch{return null}}function Fe(e,t){let n=Pe(),a=n?.layers||[],o=n?.scentSimulation||null,s=!1,c=n?.contextResult||null,u=!1,d=n?.selectedMood||null,f=n?.selectedOccasion||null,p=n?.selectedSeason||null,m=n?.selectedTime||null,h=n?.selectedIntensity||5;function g(){Ne({layers:a,scentSimulation:o,contextResult:c,selectedMood:d,selectedOccasion:f,selectedSeason:p,selectedTime:m,selectedIntensity:h})}let _=JSON.parse(sessionStorage.getItem(`labPending`)||`[]`);_.length>0&&(_.forEach(e=>{let t=l(e);t&&!a.find(t=>t.perfumeId===e)&&a.push({perfumeId:e,amount:t.format===`spray`?2:3,unit:t.format===`spray`?`sprays`:`drops`})}),sessionStorage.removeItem(`labPending`),g());function v(){e.innerHTML=`
      <div class="page__container">
                      ...
                      <div class="lab-bottle-row">
                        ${t?`
                          <button class="lab-bottle-btn ${r?`lab-bottle-btn--added`:``}" data-id="${t.id}" style="--region-color: ${e.color};" title="${e.name} Spray">
                            <img src="${Ae[e.id]}" alt="${e.name} Spray" class="lab-bottle-img" loading="lazy" decoding="async" />
                        ...
                        ${n?`
                          <button class="lab-bottle-btn ${o?`lab-bottle-btn--added`:``}" data-id="${n.id}" style="--region-color: ${e.color};" title="${e.name} Oil">
                            <img src="${je[e.id]}" alt="${e.name} Oil" class="lab-bottle-img" loading="lazy" decoding="async" />
              ...
              <div class="lab-advisor__form">
                <div class="input-group">
                  ...
                  <div class="lab-advisor__chips" id="mood-chips">
                    ${Se.map(e=>`<button class="lab-chip ${d===e.id?`lab-chip--active`:``}" data-value="${e.id}">${e.icon} ${e.name}</button>`).join(``)}
                  </div>
                </div>
                ...
                <div class="input-group">
                  ...
                  <div class="lab-advisor__chips" id="occasion-chips">
                    ${Ce.map(e=>`<button class="lab-chip ${f===e.id?`lab-chip--active`:``}" data-value="${e.id}">${e.icon} ${e.name}</button>`).join(``)}
                  </div>
                </div>
                ...
                <div class="input-group">
                  ...
                  <div class="lab-advisor__chips" id="season-chips">
                    ${we.map(e=>`<button class="lab-chip ${p===e.id?`lab-chip--active`:``}" data-value="${e.id}">${e.icon} ${e.name}</button>`).join(``)}
                  </div>
                </div>
            ...
            <div class="lab-layers" id="lab-layers">
              ...
              `:a.map((e,t)=>{let n=l(e.perfumeId),i=r.find(e=>e.id===n.region);return`
                  <div class="lab-layer" data-idx="${t}" style="--region-color: ${i.color};">
                    <div class="lab-layer__bg" style="background-image: url('${ke[i.id]}')"></div>
...
`).filter(e=>e.trim()).filter(e=>!e.match(/^(OVERALL|SILLAGE)/i)).map(e=>{if(e.match(/^(OPENING|HEART|DRY DOWN)/i)){let t=e.indexOf(`:`);return`<p class="sim-section"><span class="sim-label">${e.substring(0,t).trim()}</span><span class="sim-body">${e.substring(t+1).trim()}</span></p>`}return`<p>${e}</p>`}).join(``):``}function Le(){if(document.getElementById(`lab-styles`))return;let e=document.createElement(`style`);e.id=`lab-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e)}var Re=`/mon_accord/assets/folder-DAYqs9Dj.webp`,ze={scandinavian:new URL(`/mon_accord/assets/scandinavian-DvtLirp4.webp`,``+import.meta.url).href,eastasia:new URL(`/mon_accord/assets/east_asia-UzXNmAB4.webp`,``+import.meta.url).href,southafrica:new URL(`/mon_accord/assets/south_africa-PFpjigF9.webp`,``+import.meta.url).href,mediterranean:new URL(`/mon_accord/assets/mediterranean-CV0fuGZk.webp`,``+import.meta.url).href,southamerica:new URL(`/mon_accord/assets/south_america-DyzbduD3.webp`,``+import.meta.url).href,middleeast:new URL(`/mon_accord/assets/middle_east-Bmlf8LlT.webp`,``+import.meta.url).href},Be={scandinavian:new URL(`/mon_accord/assets/scandinavian-BBoj4W5D.webp`,``+import.meta.url).href,eastasia:new URL(`/mon_accord/assets/east_asia-D93RVLet.webp`,``+import.meta.url).href,southafrica:new URL(`/mon_accord/assets/south_africa-hdHFYwXs.webp`,``+import.meta.url).href,mediterranean:new URL(`/mon_accord/assets/mediterranean-B_fMAvaC.webp`,``+import.meta.url).href,southamerica:new URL(`/mon_accord/assets/south_america-DcR51yl4.webp`,``+import.meta.url).href,middleeast:new URL(`/mon_accord/assets/middle_east-DMI8-64c.webp`,``+import.meta.url).href},Ve={"mugler-angel":new URL(`/mon_accord/assets/angel-JaKC4iyN.webp`,``+import.meta.url).href,"ysl-black-opium":new URL(`/mon_accord/assets/black_opium-CwBrp2qb.webp`,``+import.meta.url).href,"lancome-la-vie-est-belle":new URL(`/mon_accord/assets/la_vie_est_belle-CHGqLg72.webp`,``+import.meta.url).href},He=[`mugler-angel`,`ysl-black-opium`,`lancome-la-vie-est-belle`],Ue=[{id:`evening`,name:`Evening Wear`},{id:`daytime`,name:`Daytime`},{id:`office`,name:`Office`},{id:`weekend`,name:`Weekend`},{id:`seasonal`,name:`Seasonal`}],We=[{id:`default-ev-1`,name:`Velvet Dusk`,folderId:`evening`,layers:[{perfumeId:`middleeast-spray`,amount:3,unit:`sprays`},{perfumeId:`southafrica-oil`,amount:2,unit:`drops`},{perfumeId:`scandinavian-oil`,amount:1,unit:`drops`}]},{id:`default-ev-2`,name:`Golden Night`,folderId:`evening`,layers:[{perfumeId:`southamerica-spray`,amount:3,unit:`sprays`},{perfumeId:`middleeast-oil`,amount:2,unit:`drops`}]},{id:`default-ev-3`,name:`Night Bloom`,folderId:`evening`,layers:[{perfumeId:`mediterranean-spray`,amount:2,unit:`sprays`},{perfumeId:`eastasia-oil`,amount:2,unit:`drops`},{perfumeId:`middleeast-oil`,amount:1,unit:`drops`}]},{id:`default-da-1`,name:`Fresh Morning`,folderId:`daytime`,layers:[{perfumeId:`scandinavian-spray`,amount:3,unit:`sprays`},{perfumeId:`mediterranean-oil`,amount:1,unit:`drops`}]},{id:`default-da-2`,name:`Sun Garden`,folderId:`daytime`,layers:[{perfumeId:`mediterranean-spray`,amount:2,unit:`sprays`},{perfumeId:`eastasia-spray`,amount:2,unit:`sprays`},{perfumeId:`scandinavian-oil`,amount:1,unit:`drops`}]},{id:`default-da-3`,name:`Coastal Breeze`,folderId:`daytime`,layers:[{perfumeId:`scandinavian-spray`,amount:2,unit:`sprays`},{perfumeId:`southamerica-spray`,amount:2,unit:`sprays`}]},{id:`default-of-1`,name:`Clean Presence`,folderId:`office`,layers:[{perfumeId:`scandinavian-spray`,amount:2,unit:`sprays`},{perfumeId:`eastasia-oil`,amount:1,unit:`drops`}]},{id:`default-of-2`,name:`Polished Air`,folderId:`office`,layers:[{perfumeId:`mediterranean-spray`,amount:2,unit:`sprays`},{perfumeId:`scandinavian-oil`,amount:1,unit:`drops`}]},{id:`default-of-3`,name:`Subtle Focus`,folderId:`office`,layers:[{perfumeId:`eastasia-spray`,amount:2,unit:`sprays`},{perfumeId:`scandinavian-oil`,amount:1,unit:`drops`}]},{id:`default-we-1`,name:`Lazy Sunday`,folderId:`weekend`,layers:[{perfumeId:`southamerica-spray`,amount:3,unit:`sprays`},{perfumeId:`eastasia-oil`,amount:2,unit:`drops`}]},{id:`default-we-2`,name:`Adventure Trail`,folderId:`weekend`,layers:[{perfumeId:`southafrica-spray`,amount:3,unit:`sprays`},{perfumeId:`scandinavian-oil`,amount:1,unit:`drops`}]},{id:`default-we-3`,name:`Free Spirit`,folderId:`weekend`,layers:[{perfumeId:`mediterranean-spray`,amount:2,unit:`sprays`},{perfumeId:`southamerica-oil`,amount:2,unit:`drops`},{perfumeId:`scandinavian-spray`,amount:1,unit:`sprays`}]},{id:`default-se-1`,name:`Winter Warmth`,folderId:`seasonal`,layers:[{perfumeId:`middleeast-spray`,amount:3,unit:`sprays`},{perfumeId:`southafrica-oil`,amount:2,unit:`drops`}]},{id:`default-se-2`,name:`Spring Bloom`,folderId:`seasonal`,layers:[{perfumeId:`mediterranean-spray`,amount:2,unit:`sprays`},{perfumeId:`scandinavian-spray`,amount:2,unit:`sprays`},{perfumeId:`eastasia-oil`,amount:1,unit:`drops`}]},{id:`default-se-3`,name:`Autumn Spice`,folderId:`seasonal`,layers:[{perfumeId:`southafrica-spray`,amount:2,unit:`sprays`},{perfumeId:`middleeast-oil`,amount:2,unit:`drops`}]}];function Ge(e,n){if(!t.get(`vault_defaults_seeded`,!1)){let e=t.getVault(),n=new Set(e.map(e=>e.id)),r=Date.now();We.forEach((t,i)=>{n.has(t.id)||e.push({...t,savedAt:r+i})}),t.set(`vault`,e),t.set(`vault_defaults_seeded`,!0)}let a=t.getOwnedPerfumes(),s=He.filter(e=>!a.loreal.includes(e));s.length&&(a.loreal=[...a.loreal,...s],t.setOwnedPerfumes(a));let c=t.get(`vault_folders`,null),u;if(!c)u=Ue.map(e=>({...e})),t.set(`vault_folders`,u);else{let e=c.filter(e=>e.id!==`default`),n=new Set(e.map(e=>e.id)),r=Ue.filter(e=>!n.has(e.id));u=[...e,...r].map(e=>({id:e.id,name:e.name})),t.set(`vault_folders`,u)}let d=null,f=!1,p=null,m=null;function h(){t.set(`vault_folders`,u)}function g(e){return t.getVault().filter(t=>t.folderId===e)}function _(){let n=t.getVault();e.innerHTML=`
      <div class="page__container">
        ${d?b(d,n):v(n)}
      </div>
      ${x()}
    `,Ke(),S(n)}function v(e){return`
          ...
          <div class="vault-folders-grid">
            ${u.map(e=>{let t=g(e.id).length;return`
                <div class="vault-folder-card card card--interactive" data-folder="${e.id}">
                  <img src="${Re}" class="vault-folder-icon" alt="folder" loading="lazy" decoding="async" />
    ...
    `}function y(){let e=t.getOwnedPerfumes();function n(e){return e.length?`<div class="vault-bottle-grid">
        ${e.map(e=>{let t=l(e),n=t?r.find(e=>e.id===t.region):null,i=t?.format===`spray`?ze[t.region]:Be[t.region],a=t?.name||e;return`
        ...
        ${e.map(e=>{let t=o.find(t=>t.id===e),n=Ve[e],r=t?t.name:e,i=t?.brand||``;return`
                      ...
                      <div class="vault-modal-bottle-row">
                        ${n?`
                          <button class="vault-modal-bottle-btn vault-owned-add-btn ${a?`vault-modal-bottle-btn--owned`:``}"
                            ...
                            ${a?`disabled`:``}>
                            <img src="${ze[t.id]}" alt="Spray" class="vault-modal-bottle-img" loading="lazy" decoding="async" />
                        ...
                        ${r?`
                          <button class="vault-modal-bottle-btn vault-owned-add-btn ${o?`vault-modal-bottle-btn--owned`:``}"
                            ...
                            ${o?`disabled`:``}>
                            <img src="${Be[t.id]}" alt="Oil" class="vault-modal-bottle-img" loading="lazy" decoding="async" />
...
Respond in EXACTLY this JSON format (no markdown, no code blocks):
{
  ...
  "scentDescription": "Vivid 2-sentence sensory preview"
        ...
        <div class="community-choice-row">
          <div class="community-choice-card">
            <div class="community-choice-card__photo-wrap">
              <img src="${Ze}" alt="Duygu Özaslan" class="community-choice-card__photo" loading="lazy" decoding="async" />
            </div>
    ...
    `,tt(),k(n,i)}function te(e){let t=[...i.map(e=>({id:e.id,label:`${r.find(t=>t.id===e.region)?.icon||``} ${e.name} (${e.format})`,group:`Mon Accord`})),...o.map(e=>({id:e.id,label:`${e.brand} — ${e.name}`,group:`L'Oreal Luxe`}))];return`
  ...
  `:`<p style="font-size:var(--text-sm);color:var(--text-tertiary);padding:var(--space-lg);">No suggestion available.</p>`}function tt(){if(document.getElementById(`community-styles`))return;let e=document.createElement(`style`);e.id=`community-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e)}var nt=`/mon_accord/assets/Sephora-Logo-0PIDe1Np.png`,rt=`/mon_accord/assets/Boyner_Logo-CbMLtvDJ.webp`,it=`/mon_accord/assets/Trendyol_logo-CfMQtlYm.png`,at=`/mon_accord/assets/hepsiburada-logo-I_Ul_zcU.png`,ot={scandinavian:new URL(`/mon_accord/assets/scandinavian-DvtLirp4.webp`,``+import.meta.url).href,eastasia:new URL(`/mon_accord/assets/east_asia-UzXNmAB4.webp`,``+import.meta.url).href,southafrica:new URL(`/mon_accord/assets/south_africa-PFpjigF9.webp`,``+import.meta.url).href,mediterranean:new URL(`/mon_accord/assets/mediterranean-CV0fuGZk.webp`,``+import.meta.url).href,southamerica:new URL(`/mon_accord/assets/south_america-DyzbduD3.webp`,``+import.meta.url).href,middleeast:new URL(`/mon_accord/assets/middle_east-Bmlf8LlT.webp`,``+import.meta.url).href},st={scandinavian:new URL(`/mon_accord/assets/scandinavian-BBoj4W5D.webp`,``+import.meta.url).href,eastasia:new URL(`/mon_accord/assets/east_asia-D93RVLet.webp`,``+import.meta.url).href,southafrica:new URL(`/mon_accord/assets/south_africa-hdHFYwXs.webp`,``+import.meta.url).href,mediterranean:new URL(`/mon_accord/assets/mediterranean-B_fMAvaC.webp`,``+import.meta.url).href,southamerica:new URL(`/mon_accord/assets/south_america-DcR51yl4.webp`,``+import.meta.url).href,middleeast:new URL(`/mon_accord/assets/middle_east-DMI8-64c.webp`,``+import.meta.url).href};function ct(e,n){let a=t.getShopCart(),o=[...new Set(t.consumePendingShopCart())],s=[...new Set([...a,...o])],c=s.map(e=>({id:e}));if(o.length){let e=s.length-a.length;window.showToast(`Added ${e} new item${e===1?``:`s`} from your recommended combination.`)}u();function u(){t.setShopCart(c.map(e=>e.id))}function d(){let a=t.getOwnedPerfumes().monAccord||[];lt(a,c),e.innerHTML=`
      <div class="page__container">
                  ...
                  <div class="shop-region-card__products">
                    ${t?(()=>{let n=c.find(e=>e.id===t.id),r=a.includes(t.id);return`
                        <button class="shop-bottle-btn ${n?`shop-bottle-btn--in-cart`:``} ${r?`shop-bottle-btn--owned`:``}" data-id="${t.id}" style="--region-color:${e.color};">
                          ...
                          <img src="${ot[e.id]}" class="shop-bottle-img" alt="Spray" loading="lazy" decoding="async" />
                    ...
                    ${n?(()=>{let t=c.find(e=>e.id===n.id),r=a.includes(n.id);return`
                        <button class="shop-bottle-btn ${t?`shop-bottle-btn--in-cart`:``} ${r?`shop-bottle-btn--owned`:``}" data-id="${n.id}" style="--region-color:${e.color};">
                          ...
                          ${r?`<div class="shop-bottle-owned">Owned</div>`:``}
                          <img src="${st[e.id]}" class="shop-bottle-img" alt="Oil" loading="lazy" decoding="async" />
    ...
    `,dt(),e.querySelectorAll(`.shop-bottle-btn`).forEach(e=>{e.addEventListener(`click`,t=>{t.stopPropagation();let n=e.dataset.id,r=c.findIndex(e=>e.id===n);r>=0?c.splice(r,1):c.push({id:n}),u(),d()})}),e.querySelectorAll(`.shop-cart__item-remove`).forEach(e=>{e.addEventListener(`click`,()=>{c=c.filter(t=>t.id!==e.dataset.id),u(),d()})});let o=e.querySelector(`#btn-confirm-order`);o&&o.addEventListener(`click`,()=>{ut(c,e,n)})}d()}function lt(e,t){if(!e.length)return null;let n=t.map(e=>e.id),r=e.map(e=>l(e)).filter(Boolean),a=[...new Set(r.flatMap(e=>e.scentFamily.split(`-`)))],o=i.filter(t=>!e.includes(t.id)&&!n.includes(t.id)&&t.scentFamily.split(`-`).some(e=>a.includes(e))).slice(0,2);return o.length?`Based on your owned ${r.map(e=>e.name).join(` & `)}: try adding ${o.map(e=>e.name).join(` or `)}.`:null}function ut(e,n,r){t.clearShopCart();let i=document.createElement(`div`);i.className=`modal-overlay`,i.innerHTML=`
        ...
        <div class="order-retailers">
          <div class="order-retailers__grid">
            <div class="order-retailer-card" aria-label="Sephora">
              <img src="${nt}" alt="Sephora" class="order-retailer-card__logo" loading="lazy" decoding="async" />
            </div>
            <div class="order-retailer-card" aria-label="Boyner">
              <img src="${rt}" alt="Boyner" class="order-retailer-card__logo" loading="lazy" decoding="async" />
            </div>
            <div class="order-retailer-card" aria-label="Trendyol">
              <img src="${it}" alt="Trendyol" class="order-retailer-card__logo" loading="lazy" decoding="async" />
            </div>
            <div class="order-retailer-card" aria-label="Hepsiburada">
              <img src="${at}" alt="Hepsiburada" class="order-retailer-card__logo" loading="lazy" decoding="async" />
            </div>
          </div>
        </div>
  ...
  `,document.body.appendChild(e),document.getElementById(`dt-skip`).addEventListener(`click`,X),document.getElementById(`dt-next`).addEventListener(`click`,()=>{clearTimeout(Y),clearInterval(K),Mt()})}function Pt(){document.getElementById(`dt-card`)?.remove(),document.getElementById(`dt-flash`)?.remove()}function Ft(){q&&X(),B=window.location.hash||``,V=pt(localStorage),H=pt(sessionStorage),U=window.__retakeQuiz,localStorage.clear(),sessionStorage.clear(),delete window.__retakeQuiz,localStorage.removeItem(_t),q=!0,J=0,Nt(),jt(0)}function X(){q=!1,clearTimeout(Y),clearInterval(K),mt(localStorage,V),mt(sessionStorage,H),V=null,H=null,U===void 0?delete window.__retakeQuiz:window.__retakeQuiz=U,U=void 0,(B||``)!==(window.location.hash||``)&&(window.location.hash=B||`#landing`),B=``,Pt()}function It(){if(document.getElementById(`dt-styles`))return;let e=document.createElement(`style`);e.id=`dt-styles`,e.textContent=`
    #dt-card {
      position: fixed;
      z-index: 99995;
      top: 0;
  ...
  `,document.head.appendChild(e)}var Z=document.getElementById(`app`);function Q(e){document.documentElement.setAttribute(`data-theme`,e),t.set(`theme`,e)}function Lt(){let e=t.get(`theme`,`dark`);document.documentElement.setAttribute(`data-theme`,e)}var Rt={"":f,"#landing":f,"#profile":fe,"#lab":Fe,"#vault":Ge,"#shop":ct,"#community":$e};function zt(){return window.location.hash||``}function Bt(e){window.location.hash=e}function $(){let e=zt(),t=Rt[e]||f;Z.innerHTML=``,Z.appendChild(n(Bt,e));let r=document.createElement(`div`);if(r.className=`page page-enter`,r.id=`page-content`,t(r,Bt),Z.appendChild(r),!document.querySelector(`.toast-container`)){let e=document.createElement(`div`);e.className=`toast-container`,e.id=`toast-container`,document.body.appendChild(e)}window.scrollTo({top:0,behavior:`auto`})}window.showToast=function(e,t=`success`){let n=document.getElementById(`toast-container`);if(!n)return;let r=document.createElement(`div`);r.className=`toast toast--${t}`,r.innerHTML=`<span class="toast__message">${e}</span>`,n.appendChild(r),setTimeout(()=>{r.style.animation=`fadeOut 0.3s var(--ease-out) forwards`,setTimeout(()=>r.remove(),300)},3e3)},window.showSettings=function(){let e=document.querySelector(`.modal-overlay`);e&&e.remove();let n=t.get(`theme`,`dark`),r=document.createElement(`div`);r.className=`modal-overlay`,r.id=`settings-modal`,r.innerHTML=`
    <div class="modal">
      <div class="modal__header">
