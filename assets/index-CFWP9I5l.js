(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=`monaccord_`,t={get(t,n=null){try{let r=localStorage.getItem(e+t);return r?JSON.parse(r):n}catch{return n}},set(t,n){try{localStorage.setItem(e+t,JSON.stringify(n))}catch(e){console.warn(`Storage write failed:`,e)}},remove(t){localStorage.removeItem(e+t)},getProfile(){return this.get(`profile`,null)},setProfile(e){this.set(`profile`,{...e,updatedAt:Date.now()})},getVault(){return this.get(`vault`,[])},saveFormula(e){let t=this.getVault(),n=t.findIndex(t=>t.id===e.id);return n>=0?t[n]={...e,savedAt:Date.now()}:t.push({...e,id:e.id||`f-`+Date.now(),savedAt:Date.now()}),this.set(`vault`,t),this.addInteraction({type:`save`,formulaId:e.id,timestamp:Date.now()}),t},removeFormula(e){let t=this.getVault().filter(t=>t.id!==e);return this.set(`vault`,t),t},getInteractions(){return this.get(`interactions`,[])},addInteraction(e){let t=this.getInteractions();t.push({...e,timestamp:e.timestamp||Date.now()}),t.length>500&&t.splice(0,t.length-500),this.set(`interactions`,t)},getLikes(){return this.get(`likes`,[])},toggleLike(e){let t=this.getLikes(),n=t.indexOf(e);return n>=0?(t.splice(n,1),this.addInteraction({type:`unlike`,formulaId:e,timestamp:Date.now()})):(t.push(e),this.addInteraction({type:`like`,formulaId:e,timestamp:Date.now()})),this.set(`likes`,t),t},isLiked(e){return this.getLikes().includes(e)},getOwnedPerfumes(){let e=this.get(`my_perfumes`,null);return Array.isArray(e)?{monAccord:e.map(e=>e.id),loreal:[]}:e||{monAccord:[],loreal:[]}},setOwnedPerfumes(e){this.set(`my_perfumes`,e)},getApiKey(){return this.get(`gemini_api_key`,``)},setApiKey(e){this.set(`gemini_api_key`,e)},getQuizState(){return this.get(`quiz_state`,null)},setQuizState(e){this.set(`quiz_state`,e)},clearQuizState(){this.remove(`quiz_state`)},setPendingShopCart(e){this.set(`pending_shop_cart`,e)},consumePendingShopCart(){let e=this.get(`pending_shop_cart`,[]);return this.remove(`pending_shop_cart`),Array.isArray(e)?e:[]},getShopCart(){let e=this.get(`shop_cart`,[]);return Array.isArray(e)?e:[]},setShopCart(e){this.set(`shop_cart`,e)},clearShopCart(){this.remove(`shop_cart`)},getUsername(){return this.getProfile()?.username||`Anonymous`},getPosts(){return this.get(`community_posts`,[])},setPosts(e){this.set(`community_posts`,e)},getPostLikes(){return this.get(`post_likes`,[])},togglePostLike(e){let t=this.getPostLikes(),n=t.indexOf(e);return n>=0?t.splice(n,1):t.push(e),this.set(`post_likes`,t),t},isPostLiked(e){return this.getPostLikes().includes(e)}};function n(e,n){let r=document.createElement(`nav`);r.className=`navbar`,r.id=`main-nav`,t.getProfile();let i=[{hash:`#landing`,label:`Home`,always:!0},{hash:`#profile`,label:`Profile`,always:!0},{hash:`#lab`,label:`Layering Lab`,always:!0},{hash:`#vault`,label:`Vault`,always:!0},{hash:`#shop`,label:`Shop`,always:!0},{hash:`#community`,label:`Community`,always:!0}],a=e=>n===e||n===``&&e===`#landing`;r.innerHTML=`
  ...
  `,document.head.appendChild(e)}var m=`/mon_accord/assets/aromatic-CmpTH1Ki.png`,h=`/mon_accord/assets/citrus-CUxOPFui.png`,g=`/mon_accord/assets/floral-4tgVvd3d.png`,_=`/mon_accord/assets/fresh-BHcNl6ul.png`,v=`/mon_accord/assets/gourmand-DmKdC6Sb.png`,y=`/mon_accord/assets/green-C3YolgwO.png`,b=`/mon_accord/assets/musky-bxHISrED.png`,x=`/mon_accord/assets/oriental-D2UnWmBQ.png`,S=`/mon_accord/assets/spicy-BJsI8kVS.png`,C=`/mon_accord/assets/woody-DpWZUNXq.png`,w=`https://mon-accord-ai.alpgiraykacira.workers.dev`,T=`b779d4d71581850227941ec6f62abdb1b9060ca364e361c49355d25395ba9437`,E=`https://generativelanguage.googleapis.com/v1beta/models`,D=`gemini-3.1-flash-lite`,O=6e3,k=`You are Mon Accord's AI Perfume Advisor — a world-class fragrance expert specializing in scent layering and olfactory profiling.
...
Keep responses concise but rich. Use fragrance terminology naturally.`,A=(e,t=400)=>({contents:[{parts:[{text:e.slice(0,O)}]}],systemInstruction:{parts:[{text:k}]},generationConfig:{maxOutputTokens:t,temperature:.7,candidateCount:1,thinkingConfig:{thinkingBudget:0}}});function j(e,t){return t===429||e.includes(`429`)||e.includes(`quota`)||e.includes(`RESOURCE_EXHAUSTED`)?`rate-limit`:t===401||t===403||e.includes(`API_KEY`)||e.includes(`API key`)?`invalid-key`:e.includes(`fetch`)||e.includes(`network`)||e.includes(`Failed to fetch`)?`network`:`unknown`}function M(e,t){switch(e){case`rate-limit`:return`Rate limit reached. Please wait ${t||30} seconds and try again.`;case`invalid-key`:return`Service key is invalid. Please contact the site owner.`;case`network`:return`Network error. Please check your connection and try again.`;default:return`Request failed. Please try again.`}}async function N(e,n){let r=A(e,n);{let e={"Content-Type":`application/json`};e[`X-Worker-Token`]=T;let t=await fetch(w,{method:`POST`,headers:e,body:JSON.stringify(r)}),n=await t.json();if(!t.ok){let e=n?.error?.message||`HTTP ${t.status}`;throw Object.assign(Error(e),{status:t.status})}return n}let i=t.getApiKey();if(!i)throw Object.assign(Error(`no-api-key`),{status:0});let a=await fetch(`${E}/${D}:generateContent?key=${i}`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(r)}),o=await a.json();if(!a.ok){let e=o?.error?.message||`HTTP ${a.status}`;throw Object.assign(Error(e),{status:a.status})}return o}async function P(e,t=2,n){try{let t=await N(e,n),r=t?.candidates?.[0]?.content?.parts?.[0]?.text;return r?{success:!0,text:r}:(console.error(`Empty Gemini response`,t),{success:!1,error:`empty-response`,text:`No response received. Please try again.`})}catch(r){let i=r.message||String(r),a=r.status??0;if(console.error(`AI error:`,i),i===`no-api-key`)return{success:!1,error:`no-api-key`,text:`This feature is not available. Please contact the site owner.`};let o=j(i,a);if(o===`rate-limit`&&t>0){let r=i.match(/retry[^0-9]*(\d+)/i),a=r?parseInt(r[1]):30;return console.log(`Rate limited. Waiting ${a}s… (${t} retries left)`),await new Promise(e=>setTimeout(e,(a+2)*1e3)),P(e,t-1,n)}let s=i.match(/retry[^0-9]*(\d+)/i);return{success:!1,error:o,text:M(o,s?parseInt(s[1]):void 0)}}}function F(){return!0}async function I(e){let n=await P(ee(e),2,700);if(n.success){let r=te(n.text,e);return t.setProfile(r),t.addInteraction({type:`profile-created`,profile:r.archetype}),{success:!0,profile:r}}return{success:!1,error:n.text}}function ee(e){let t=e.scentFamilies?.join(`, `)||`not specified`,n=(e.knownPerfumes||[]).map(e=>{let t=o.find(t=>t.id===e);return t?`${t.brand} ${t.name} (${t.family})`:e}).join(`, `)||`none selected`,r=e.interestedRegions?.join(`, `)||`all regions`;return`Analyze this user's fragrance preferences and create their olfactory profile.
...
`)}}var ie=Object.fromEntries([`fresh`,`floral`,`woody`,`oriental`,`citrus`,`gourmand`,`green`,`aromatic`,`spicy`,`musky`].map(e=>[e,new URL(Object.assign({"../assets/quiz_scent_families_v2/aromatic.png":m,"../assets/quiz_scent_families_v2/citrus.png":h,"../assets/quiz_scent_families_v2/floral.png":g,"../assets/quiz_scent_families_v2/fresh.png":_,"../assets/quiz_scent_families_v2/gourmand.png":v,"../assets/quiz_scent_families_v2/green.png":y,"../assets/quiz_scent_families_v2/musky.png":b,"../assets/quiz_scent_families_v2/oriental.png":x,"../assets/quiz_scent_families_v2/spicy.png":S,"../assets/quiz_scent_families_v2/woody.png":C})[`../assets/quiz_scent_families_v2/${e}.png`],import.meta.url).href])),ae={elegant:new URL(`/mon_accord/assets/elegant_classic-BiRAW1Ly.png`,``+import.meta.url).href,adventurous:new URL(`/mon_accord/assets/adventurous_bold-Bz6pRBer.png`,``+import.meta.url).href,romantic:new URL(`/mon_accord/assets/romantic_dreamy-CNzM-gWm.png`,``+import.meta.url).href,minimalist:new URL(`/mon_accord/assets/minimalist_clean-Dr7j3KT0.png`,``+import.meta.url).href,creative:new URL(`/mon_accord/assets/creative_expressive-D6akHWmL.png`,``+import.meta.url).href,confident:new URL(`/mon_accord/assets/confident_powerful-Bas-bCGv.png`,``+import.meta.url).href},L=5;function R(e,n){let r=t.getProfile();if(r&&!window.__retakeQuiz){de(e,r,n);return}window.__retakeQuiz=!1;let i=t.getQuizState(),a=i?.step||1,o=i?.answers||{username:``,scentFamilies:[],knownPerfumes:[],sillage:5,longevity:5,intensity:5,personality:``,notes:``};function s(){t.setQuizState({step:a,answers:o}),e.innerHTML=`
      <div class="page__container">
        <div class="quiz-container">
          <div class="quiz-stepper">
            ${Array.from({length:L},(e,t)=>{let n=t+1,r=n<a?`completed`:n===a?`active`:``,i=n<a?`done`:``;return`<div class="quiz-stepper__item ${r}"><div class="quiz-stepper__circle">${n<a?`✓`:String(n)}</div></div>${t<L-1?`<div class="quiz-stepper__line ${i}"></div>`:``}`}).join(``)}
          </div>
          ...
          <div class="quiz-actions">
            ...
            ${a<L?`<button class="btn btn--primary" id="quiz-next">Continue →</button>`:`<button class="btn btn--primary" id="quiz-finish">
                  ${F()?`✦ Generate My Profile`:`✦ Generate Profile`}
                </button>`}
          </div>
        </div>
      </div>
    `,fe(),se(a,o,e);let r=e.querySelector(`#quiz-back`),i=e.querySelector(`#quiz-next`),c=e.querySelector(`#quiz-finish`);r&&r.addEventListener(`click`,()=>{B(a,o,e),a--,s()}),i&&i.addEventListener(`click`,()=>{B(a,o,e),a++,s()}),c&&c.addEventListener(`click`,async()=>{if(B(a,o,e),!F()){window.showToast(`Please set your Gemini API key in Settings first.`,`error`),window.showSettings();return}c.disabled=!0,c.innerHTML=`<span class="loading-spinner"></span> Generating...`;let r=e.querySelector(`#generation-status`);r||(r=document.createElement(`p`),r.id=`generation-status`,r.style.cssText=`font-size: var(--text-xs); color: var(--text-tertiary); text-align: center; margin-top: var(--space-sm);`,c.parentElement.appendChild(r)),r.textContent=`Analysing your preferences...`;let i=await I(o);i.success?(i.profile.username=o.username||`Anonymous`,t.setProfile(i.profile),t.clearQuizState(),V(e,i.profile,n),window.showToast(`Your olfactory profile has been created! ✦`)):(c.disabled=!1,c.innerHTML=`✦ Generate My Profile`,r.textContent=``,window.showToast(i.error||`Failed to generate profile.`,`error`))})}s()}function oe(e,t){switch(e){case 1:return`
        ...
        <div class="quiz-grid quiz-grid--families">
          ${a.map(e=>`
            <div class="quiz-option quiz-option--img-card quiz-option--family-card ${t.scentFamilies.includes(e.id)?`quiz-option--selected`:``}" data-value="${e.id}" id="family-${e.id}">
              <img class="quiz-family-img" src="${ie[e.id]}" alt="${e.name}" loading="lazy" decoding="async" />
        ...
        <div class="quiz-grid quiz-grid--context">
          ${[{id:`elegant`,name:`Elegant & Classic`,desc:`Timeless sophistication`},{id:`adventurous`,name:`Adventurous & Bold`,desc:`Love discovering the new`},{id:`romantic`,name:`Romantic & Dreamy`,desc:`Soft, poetic, emotional`},{id:`minimalist`,name:`Minimalist & Clean`,desc:`Less is more`},{id:`creative`,name:`Creative & Expressive`,desc:`Unique, unconventional`},{id:`confident`,name:`Confident & Powerful`,desc:`Commands attention`}].map(e=>`
            <div class="quiz-option quiz-option--img-card quiz-option--family-card quiz-option--trait-card ${t.personality===e.id?`quiz-option--selected`:``}" data-value="${e.id}" id="ctx-${e.id}">
              <img class="quiz-family-img" src="${ae[e.id]}" alt="${e.name}" loading="lazy" decoding="async" />
              <div class="quiz-family-overlay">
                <span class="quiz-family-name">${e.name}</span>
              </div>
            </div>
      ...
      `}}function z(e,t){let n=t?o.filter(e=>e.name.toLowerCase().includes(t.toLowerCase())||e.brand.toLowerCase().includes(t.toLowerCase())):o,r={};return n.forEach(e=>{r[e.brand]||(r[e.brand]=[]),r[e.brand].push(e)}),Object.entries(r).map(([t,n])=>`
            ...
            <div class="lab-advisor">
              ...
              <div class="lab-advisor__form">
                ...
                <div class="slider-container">
                  <div class="slider-header">
                    <span class="slider-label">Intensity</span>
                    <span class="slider-value" id="advisor-intensity-val">${(H.find(e=>e.value===h)||{}).name||`Moderate`}</span>
                  </div>
                ...
                <div class="lab-advisor__result mt-lg" id="advisor-result">
                  <div class="ai-response">
                    ...
                    <div class="ai-response__text ai-response__text--compact">
                      ${c.reasoning?`<p>${G(c.reasoning,150)}</p>`:``}
                      ${c.scentPreview?`<p><em>${G(c.scentPreview,100)}</em></p>`:``}
                      ${c.tips?`<p style="color: var(--accent); font-size: var(--text-xs);">◈ ${G(c.tips,100)}</p>`:``}
                    </div>
                  </div>
                  ${c.layers?.length>0?`
...
`).filter(e=>e.trim()).filter(e=>!e.match(/^(OVERALL|SILLAGE)/i)).map(e=>{if(e.match(/^(OPENING|HEART|DRY DOWN)/i)){let t=e.indexOf(`:`);return`<p class="sim-section"><span class="sim-label">${e.substring(0,t).trim()}</span><span class="sim-body">${e.substring(t+1).trim()}</span></p>`}return`<p>${e}</p>`}).join(``):``}function De(){if(document.getElementById(`lab-styles`))return;let e=document.createElement(`style`);e.id=`lab-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e)}var Oe=`/mon_accord/assets/folder-DAYqs9Dj.webp`,K={scandinavian:new URL(`/mon_accord/assets/scandinavian-DvtLirp4.webp`,``+import.meta.url).href,eastasia:new URL(`/mon_accord/assets/east_asia-UzXNmAB4.webp`,``+import.meta.url).href,southafrica:new URL(`/mon_accord/assets/south_africa-PFpjigF9.webp`,``+import.meta.url).href,mediterranean:new URL(`/mon_accord/assets/mediterranean-CV0fuGZk.webp`,``+import.meta.url).href,southamerica:new URL(`/mon_accord/assets/south_america-DyzbduD3.webp`,``+import.meta.url).href,middleeast:new URL(`/mon_accord/assets/middle_east-Bmlf8LlT.webp`,``+import.meta.url).href},q={scandinavian:new URL(`/mon_accord/assets/scandinavian-BBoj4W5D.webp`,``+import.meta.url).href,eastasia:new URL(`/mon_accord/assets/east_asia-D93RVLet.webp`,``+import.meta.url).href,southafrica:new URL(`/mon_accord/assets/south_africa-hdHFYwXs.webp`,``+import.meta.url).href,mediterranean:new URL(`/mon_accord/assets/mediterranean-B_fMAvaC.webp`,``+import.meta.url).href,southamerica:new URL(`/mon_accord/assets/south_america-DcR51yl4.webp`,``+import.meta.url).href,middleeast:new URL(`/mon_accord/assets/middle_east-DMI8-64c.webp`,``+import.meta.url).href},ke={"mugler-angel":new URL(`/mon_accord/assets/angel-JaKC4iyN.webp`,``+import.meta.url).href,"ysl-black-opium":new URL(`/mon_accord/assets/black_opium-CwBrp2qb.webp`,``+import.meta.url).href,"lancome-la-vie-est-belle":new URL(`/mon_accord/assets/la_vie_est_belle-CHGqLg72.webp`,``+import.meta.url).href},Ae=[`mugler-angel`,`ysl-black-opium`,`lancome-la-vie-est-belle`],J=[{id:`evening`,name:`Evening Wear`},{id:`daytime`,name:`Daytime`},{id:`office`,name:`Office`},{id:`weekend`,name:`Weekend`},{id:`seasonal`,name:`Seasonal`}],je=[{id:`default-ev-1`,name:`Velvet Dusk`,folderId:`evening`,layers:[{perfumeId:`middleeast-spray`,amount:3,unit:`sprays`},{perfumeId:`southafrica-oil`,amount:2,unit:`drops`},{perfumeId:`scandinavian-oil`,amount:1,unit:`drops`}]},{id:`default-ev-2`,name:`Golden Night`,folderId:`evening`,layers:[{perfumeId:`southamerica-spray`,amount:3,unit:`sprays`},{perfumeId:`middleeast-oil`,amount:2,unit:`drops`}]},{id:`default-ev-3`,name:`Night Bloom`,folderId:`evening`,layers:[{perfumeId:`mediterranean-spray`,amount:2,unit:`sprays`},{perfumeId:`eastasia-oil`,amount:2,unit:`drops`},{perfumeId:`middleeast-oil`,amount:1,unit:`drops`}]},{id:`default-da-1`,name:`Fresh Morning`,folderId:`daytime`,layers:[{perfumeId:`scandinavian-spray`,amount:3,unit:`sprays`},{perfumeId:`mediterranean-oil`,amount:1,unit:`drops`}]},{id:`default-da-2`,name:`Sun Garden`,folderId:`daytime`,layers:[{perfumeId:`mediterranean-spray`,amount:2,unit:`sprays`},{perfumeId:`eastasia-spray`,amount:2,unit:`sprays`},{perfumeId:`scandinavian-oil`,amount:1,unit:`drops`}]},{id:`default-da-3`,name:`Coastal Breeze`,folderId:`daytime`,layers:[{perfumeId:`scandinavian-spray`,amount:2,unit:`sprays`},{perfumeId:`southamerica-spray`,amount:2,unit:`sprays`}]},{id:`default-da-4`,name:`Island Citrus`,folderId:`daytime`,layers:[{perfumeId:`southamerica-spray`,amount:3,unit:`sprays`},{perfumeId:`mediterranean-oil`,amount:1,unit:`drops`}]},{id:`default-of-1`,name:`Clean Presence`,folderId:`office`,layers:[{perfumeId:`scandinavian-spray`,amount:2,unit:`sprays`},{perfumeId:`eastasia-oil`,amount:1,unit:`drops`}]},{id:`default-of-2`,name:`Polished Air`,folderId:`office`,layers:[{perfumeId:`mediterranean-spray`,amount:2,unit:`sprays`},{perfumeId:`scandinavian-oil`,amount:1,unit:`drops`}]},{id:`default-we-1`,name:`Lazy Sunday`,folderId:`weekend`,layers:[{perfumeId:`southamerica-spray`,amount:3,unit:`sprays`},{perfumeId:`eastasia-oil`,amount:2,unit:`drops`}]},{id:`default-se-1`,name:`Winter Warmth`,folderId:`seasonal`,layers:[{perfumeId:`middleeast-spray`,amount:3,unit:`sprays`},{perfumeId:`southafrica-oil`,amount:2,unit:`drops`}]},{id:`default-se-2`,name:`Spring Bloom`,folderId:`seasonal`,layers:[{perfumeId:`mediterranean-spray`,amount:2,unit:`sprays`},{perfumeId:`scandinavian-spray`,amount:2,unit:`sprays`},{perfumeId:`eastasia-oil`,amount:1,unit:`drops`}]},{id:`default-se-3`,name:`Autumn Spice`,folderId:`seasonal`,layers:[{perfumeId:`southafrica-spray`,amount:2,unit:`sprays`},{perfumeId:`middleeast-oil`,amount:2,unit:`drops`}]}];function Me(e,n){if(!t.get(`vault_defaults_seeded`,!1)){let e=t.getVault(),n=new Set(e.map(e=>e.id)),r=Date.now();je.forEach((t,i)=>{n.has(t.id)||e.push({...t,savedAt:r+i})}),t.set(`vault`,e),t.set(`vault_defaults_seeded`,!0)}let a=t.getOwnedPerfumes(),s=Ae.filter(e=>!a.loreal.includes(e));s.length&&(a.loreal=[...a.loreal,...s],t.setOwnedPerfumes(a));let c=t.get(`vault_folders`,null),u;if(!c)u=J.map(e=>({...e})),t.set(`vault_folders`,u);else{let e=c.filter(e=>e.id!==`default`),n=new Set(e.map(e=>e.id)),r=J.filter(e=>!n.has(e.id));u=[...e,...r].map(e=>({id:e.id,name:e.name})),t.set(`vault_folders`,u)}let d=null,f=!1,p=null,m=null;function h(){t.set(`vault_folders`,u)}function g(e){return t.getVault().filter(t=>t.folderId===e)}function _(){let n=t.getVault();e.innerHTML=`
          ...
          <div class="vault-folders-grid">
            ${u.map(e=>{let t=g(e.id).length;return`
                <div class="vault-folder-card card card--interactive" data-folder="${e.id}">
                  <img src="${Oe}" class="vault-folder-icon" alt="folder" loading="lazy" decoding="async" />
    ...
    `}function y(){let e=t.getOwnedPerfumes();function n(e){return e.length?`<div class="vault-bottle-grid">
        ${e.map(e=>{let t=l(e),n=t?r.find(e=>e.id===t.region):null,i=t?.format===`spray`?K[t.region]:q[t.region],a=t?.name||e;return`
          ...
          ${n.map(t=>{let n=t.layers||[];return`
              <div class="vault-formula-card" data-id="${t.id}">
                ...
                <div class="vault-formula-bottles">
                  ${n.map(e=>{let t=l(e.perfumeId),n=t?r.find(e=>e.id===t.region):null,i=t?.format===`spray`?K[t.region]:q[t.region];return`
                      ...
                      <div class="vault-modal-bottle-row">
                        ${n?`
                          <button class="vault-modal-bottle-btn vault-owned-add-btn ${a?`vault-modal-bottle-btn--owned`:``}"
                            ...
                            ${a?`disabled`:``}>
                            <img src="${K[t.id]}" alt="Spray" class="vault-modal-bottle-img" loading="lazy" decoding="async" />
                        ...
                        ${r?`
                          <button class="vault-modal-bottle-btn vault-owned-add-btn ${o?`vault-modal-bottle-btn--owned`:``}"
                            ...
                            ${o?`disabled`:``}>
                            <img src="${q[t.id]}" alt="Oil" class="vault-modal-bottle-img" loading="lazy" decoding="async" />
...
`),o=await P(`Based on this user's fragrance journey, suggest a fresh remix.
...
Respond in EXACTLY this JSON format (no markdown, no code blocks):
{
  ...
  "scentDescription": "Vivid 2-sentence sensory preview"
        ...
        <div class="community-choice-row">
          <div class="community-choice-card">
            <div class="community-choice-card__photo-wrap">
              <img src="${Re}" alt="Léna" class="community-choice-card__photo" loading="lazy" decoding="async" />
            </div>
          ...
          <div class="community-choice-card">
            <div class="community-choice-card__photo-wrap">
              <img src="${ze}" alt="Squeezie" class="community-choice-card__photo" loading="lazy" decoding="async" />
            </div>
          ...
          <div class="community-choice-card">
            <div class="community-choice-card__photo-wrap">
              <img src="${Be}" alt="Stéphanie" class="community-choice-card__photo" loading="lazy" decoding="async" />
            </div>
        ...
        <div class="community-discussion-section">
          ...
          <div class="community-discussion-layout">
            ...
            <div class="community-post-list">
              ${i.length===0?`<p style="color:var(--text-tertiary);font-size:var(--text-sm);padding:var(--space-lg);">No posts yet. Be the first to share!</p>`:C(i).map(e=>`
                  <div class="community-post-item ${f===e.id?`community-post-item--active`:``}" data-post-id="${e.id}">
                    <div class="community-post-item__top">
                      <span class="community-post-item__date">${M(e.date)}</span>
                    </div>
    ...
    `,Ue(),P(n,i)}function T(e){let t=[...i.map(e=>({id:e.id,label:`${r.find(t=>t.id===e.region)?.icon||``} ${e.name} (${e.format})`,group:`Mon Accord`})),...o.map(e=>({id:e.id,label:`${e.brand} — ${e.name}`,group:`L'Oreal Luxe`}))];return`
    ...
    `}let E=[];function D(e){let n=t.isPostLiked(e.id),r=A(e);return`
    ...
    `}function O(e,t,n){return!e||!e.length?``:e.map(e=>`
      <div class="community-comment" style="margin-left:${n*20}px;">
        <div class="community-comment__meta">
          ...
          <span class="community-comment__date">${M(e.date)}</span>
        </div>
    ...
    `).join(``)}function k(e){if(e.topicType===`trending`){let t=s.find(t=>t.id===e.topicRef);return t?t.name:`Trending`}return e.topicType===`combination`?`Custom Combo`:e.topicLabel||`General`}function A(e){if(e.topicType===`trending`){let t=s.find(t=>t.id===e.topicRef);return t?`<div class="community-post-topic-badge">Trending: ${t.name}</div>`:``}return e.topicType===`combination`&&e.topicCombination?.length?`<div class="community-post-topic-badge">${e.topicCombination.map(e=>`${l(e.perfumeId)?.name||e.perfumeId} (${e.amount} ${e.unit})`).join(` + `)}</div>`:e.topicType===`free`&&e.topicLabel?`<div class="community-post-topic-badge">${e.topicLabel}</div>`:``}function j(e){let t=0;function n(e){(e||[]).forEach(e=>{t++,n(e.replies)})}return n(e.comments),t}function M(e){let t=Date.now()-e,n=Math.floor(t/6e4);if(n<60)return`${n}m ago`;let r=Math.floor(n/60);return r<24?`${r}h ago`:`${Math.floor(r/24)}d ago`}function N(e,t){for(let n of e||[]){if(n.id===t)return n;let e=N(n.replies,t);if(e)return e}return null}function P(i,a){e.querySelectorAll(`.community-sort-btn[data-sort]`).forEach(e=>{e.addEventListener(`click`,()=>{u=e.dataset.sort,w()})}),e.querySelectorAll(`.community-sort-btn[data-post-sort]`).forEach(e=>{e.addEventListener(`click`,()=>{d=e.dataset.postSort,w()})}),e.querySelectorAll(`[data-like-formula]`).forEach(e=>{e.addEventListener(`click`,n=>{n.stopPropagation(),t.toggleLike(e.dataset.likeFormula),w()})}),e.querySelectorAll(`[data-vault-formula]`).forEach(e=>{e.addEventListener(`click`,t=>{t.stopPropagation();let n=i.find(t=>t.id===e.dataset.vaultFormula);if(!n)return;let a=(n.layers||[]).map(e=>{let t=l(e.perfumeId);return t&&r.find(e=>e.id===t.region),{...e,name:t?.name||e.perfumeId}});U({...n,id:`saved-`+n.id,layers:a},{showNameInput:!1})})});let s=e.querySelector(`#btn-load-suggestion`);s&&s.addEventListener(`click`,()=>{v?.layers?.length&&(sessionStorage.setItem(`labPending`,JSON.stringify(v.layers.map(e=>e.perfumeId).filter(e=>l(e)))),n(`#lab`))}),e.querySelectorAll(`[data-post-id]`).forEach(e=>{e.classList.contains(`community-post-item`)&&e.addEventListener(`click`,()=>{f=e.dataset.postId,w()})});let c=e.querySelector(`#btn-new-post`);c&&c.addEventListener(`click`,()=>{p=!0,m=null,E=[],w()}),e.querySelectorAll(`.community-topic-btn`).forEach(e=>{e.addEventListener(`click`,()=>{m=e.dataset.topic,E=[],w()})});let h=e.querySelector(`#combo-add-layer`);h&&h.addEventListener(`click`,()=>{let t=e.querySelector(`#combo-perfume-select`),n=e.querySelector(`#combo-amount`),r=e.querySelector(`#combo-unit`);t.value&&(E.push({perfumeId:t.value,amount:parseInt(n.value)||2,unit:r.value}),g())});function g(){let t=e.querySelector(`#combo-layers`);t&&(t.innerHTML=E.map((e,t)=>{let n=l(e.perfumeId),r=o.find(t=>t.id===e.perfumeId);return`<div class="community-combo-layer"><span>${n?.name||(r?`${r.brand} — ${r.name}`:e.perfumeId)} (${e.amount} ${e.unit})</span><button class="community-combo-remove" data-idx="${t}">✕</button></div>`}).join(``),t.querySelectorAll(`.community-combo-remove`).forEach(e=>{e.addEventListener(`click`,()=>{E.splice(parseInt(e.dataset.idx),1),g()})}))}let _=e.querySelector(`#btn-cancel-post`);_&&_.addEventListener(`click`,()=>{p=!1,m=null,w()});let y=e.querySelector(`#btn-submit-post`);y&&y.addEventListener(`click`,()=>{let n=e.querySelector(`#new-post-title`)?.value.trim(),r=e.querySelector(`#new-post-content`)?.value.trim();if(!n||!r||!m){window.showToast(`Please fill in all fields.`,`error`);return}let i={id:`p-`+Date.now(),author:t.getUsername(),date:Date.now(),title:n,content:r,topicType:m,likes:0,comments:[]};m===`combination`&&(i.topicCombination=[...E]),m===`trending`&&(i.topicRef=e.querySelector(`#trending-select`)?.value||``),m===`free`&&(i.topicLabel=e.querySelector(`#free-topic-label`)?.value.trim()||`General`);let a=X();a.unshift(i),t.setPosts(a),p=!1,m=null,f=i.id,w(),window.showToast(`Post published!`)}),e.querySelectorAll(`[data-like-post]`).forEach(e=>{e.addEventListener(`click`,()=>{let n=e.dataset.likePost,r=t.isPostLiked(n);t.togglePostLike(n);let i=X(),a=i.find(e=>e.id===n);a&&(a.likes=(a.likes||0)+(r?-1:1),t.setPosts(i)),w()})});let b=e.querySelector(`#btn-add-comment`);b&&b.addEventListener(`click`,()=>{let n=e.querySelector(`#new-comment-input`)?.value.trim();if(!n)return;let r=X(),i=r.find(e=>e.id===b.dataset.postId);i&&(i.comments||=[],i.comments.push({id:`c-`+Date.now(),author:t.getUsername(),date:Date.now(),text:n,replies:[]}),t.setPosts(r),w())}),e.querySelectorAll(`.community-reply-toggle`).forEach(t=>{t.addEventListener(`click`,()=>{let n=e.querySelector(`#reply-${t.dataset.commentId}`);n&&(n.style.display=n.style.display===`none`?`flex`:`none`)})}),e.querySelectorAll(`.community-reply-submit`).forEach(n=>{n.addEventListener(`click`,()=>{let r=(e.querySelector(`#reply-${n.dataset.commentId}`)?.querySelector(`input`))?.value.trim();if(!r)return;let i=X(),a=i.find(e=>e.id===n.dataset.postId);if(a){let e=N(a.comments,n.dataset.commentId);e&&(e.replies||=[],e.replies.push({id:`r-`+Date.now(),author:t.getUsername(),date:Date.now(),text:r,replies:[]}),t.setPosts(i),w())}})})}w(),v||(async()=>{let e;if(F()){let t=await Ie();e=t.success&&t.remix?t.remix:I()}else e=I();v=e,y=!1,sessionStorage.setItem(h,JSON.stringify({date:g,remix:e})),w()})();function I(){let e=x.slice().sort((e,t)=>t.matchPercent-e.matchPercent)[0]||a[0];return{remixName:e?.name||`Daily Selection`,layers:e?.layers||[],inspiration:e?.description||`A community-loved formula selected for your profile.`,scentDescription:`Balanced for versatility across day and evening wear.`}}}function He(e,t){return t?`<div style="padding:var(--space-xl);text-align:center;"><span class="loading-spinner"></span><p style="margin-top:var(--space-md);color:var(--text-tertiary);">Preparing today's suggestion...</p></div>`:e?`
  ...
  `:`<p style="font-size:var(--text-sm);color:var(--text-tertiary);padding:var(--space-lg);">No suggestion available.</p>`}function Ue(){if(document.getElementById(`community-styles`))return;let e=document.createElement(`style`);e.id=`community-styles`,e.textContent=`
