var e=Object.create,t=Object.defineProperty,n=Object.getOwnPropertyDescriptor,r=Object.getOwnPropertyNames,i=Object.getPrototypeOf,a=Object.prototype.hasOwnProperty,o=(e,t)=>()=>(t||e((t={exports:{}}).exports,t),t.exports),s=(e,n)=>{let r={};for(var i in e)t(r,i,{get:e[i],enumerable:!0});return n||t(r,Symbol.toStringTag,{value:`Module`}),r},c=(e,i,o,s)=>{if(i&&typeof i==`object`||typeof i==`function`)for(var c=r(i),l=0,u=c.length,d;l<u;l++)d=c[l],!a.call(e,d)&&d!==o&&t(e,d,{get:(e=>i[e]).bind(null,d),enumerable:!(s=n(i,d))||s.enumerable});return e},l=(n,r,a)=>(a=n==null?{}:e(i(n)),c(r||!n||!n.__esModule?t(a,`default`,{value:n,enumerable:!0}):a,n));(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var u=`monaccord_`,d={get(e,t=null){try{let n=localStorage.getItem(u+e);return n?JSON.parse(n):t}catch{return t}},set(e,t){try{localStorage.setItem(u+e,JSON.stringify(t))}catch(e){console.warn(`Storage write failed:`,e)}},remove(e){localStorage.removeItem(u+e)},getProfile(){return this.get(`profile`,null)},setProfile(e){this.set(`profile`,{...e,updatedAt:Date.now()})},getVault(){return this.get(`vault`,[])},saveFormula(e){let t=this.getVault(),n=t.findIndex(t=>t.id===e.id);return n>=0?t[n]={...e,savedAt:Date.now()}:t.push({...e,id:e.id||`f-`+Date.now(),savedAt:Date.now()}),this.set(`vault`,t),this.addInteraction({type:`save`,formulaId:e.id,timestamp:Date.now()}),t},removeFormula(e){let t=this.getVault().filter(t=>t.id!==e);return this.set(`vault`,t),t},getInteractions(){return this.get(`interactions`,[])},addInteraction(e){let t=this.getInteractions();t.push({...e,timestamp:e.timestamp||Date.now()}),t.length>500&&t.splice(0,t.length-500),this.set(`interactions`,t)},getLikes(){return this.get(`likes`,[])},toggleLike(e){let t=this.getLikes(),n=t.indexOf(e);return n>=0?(t.splice(n,1),this.addInteraction({type:`unlike`,formulaId:e,timestamp:Date.now()})):(t.push(e),this.addInteraction({type:`like`,formulaId:e,timestamp:Date.now()})),this.set(`likes`,t),t},isLiked(e){return this.getLikes().includes(e)},getOwnedPerfumes(){let e=this.get(`my_perfumes`,null);return Array.isArray(e)?{monAccord:e.map(e=>e.id),loreal:[]}:e||{monAccord:[],loreal:[]}},setOwnedPerfumes(e){this.set(`my_perfumes`,e)},getApiKey(){return this.get(`gemini_api_key`,``)},setApiKey(e){this.set(`gemini_api_key`,e)},getQuizState(){return this.get(`quiz_state`,null)},setQuizState(e){this.set(`quiz_state`,e)},clearQuizState(){this.remove(`quiz_state`)}};function f(e,t){let n=document.createElement(`nav`);return n.className=`navbar`,n.id=`main-nav`,d.getProfile(),n.innerHTML=`
  ...
  `,e.querySelector(`#hero-cta`).addEventListener(`click`,()=>{t(n?`#lab`:`#profile`)}),e.querySelector(`#bottom-cta`).addEventListener(`click`,()=>{t(n?`#lab`:`#profile`)}),e.querySelectorAll(`.region-format-btn`).forEach(e=>{e.addEventListener(`click`,t=>{t.stopPropagation();let n=e.dataset.region,r=e.dataset.format,i=p.find(e=>e.id===n),a=m.find(e=>e.region===n&&e.format===r);if(!a||!i)return;document.querySelector(`.notes-popup`)?.remove();let o=document.createElement(`div`);o.className=`notes-popup`,o.innerHTML=`
      ...
      `,document.body.appendChild(o);let s=e.getBoundingClientRect(),c=o.querySelector(`.notes-popup__inner`);requestAnimationFrame(()=>{let e=c.offsetWidth;c.offsetHeight;let t=s.left+s.width/2-e/2,n=s.bottom+window.scrollY+10;t+e>window.innerWidth-12&&(t=window.innerWidth-e-12),t<12&&(t=12),o.style.left=t+`px`,o.style.top=n+`px`});let l=()=>o.remove();o.querySelector(`.notes-popup__close`).addEventListener(`click`,l),setTimeout(()=>document.addEventListener(`click`,l,{once:!0}),0),o.querySelector(`.notes-popup__lab-btn`).addEventListener(`click`,e=>{e.stopPropagation();let t=JSON.parse(sessionStorage.getItem(`labPending`)||`[]`);t.includes(a.id)||t.push(a.id),sessionStorage.setItem(`labPending`,JSON.stringify(t)),window.showToast(`${a.name} added to Lab!`),l()})})});let r=new IntersectionObserver(e=>{e.forEach(e=>{e.isIntersecting&&e.target.classList.add(`visible`)})},{threshold:.1});e.querySelectorAll(`.region-card, .how-step`).forEach(e=>{r.observe(e)}),S()}function x(e){return`${parseInt(e.slice(1,3),16)}, ${parseInt(e.slice(3,5),16)}, ${parseInt(e.slice(5,7),16)}`}function S(){if(document.getElementById(`landing-styles`))return;let e=document.createElement(`style`);e.id=`landing-styles`,e.textContent=`
    /* ── Hero ── */
    .hero {
      min-height: 100vh;
      display: flex;
...
`).filter(e=>e.trim()).map(e=>{if(e.match(/^(OPENING|HEART|DRY DOWN|OVERALL|SILLAGE)/i)){let[t,...n]=e.split(`:`);return`<p><strong style="color: var(--accent);">${t.trim()}:</strong> ${n.join(`:`).trim()}</p>`}return`<p>${e}</p>`}).join(``):``}function Yd(){if(document.getElementById(`lab-styles`))return;let e=document.createElement(`style`);e.id=`lab-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e)}function Xd(e,t){let n=d.get(`vault_folders`,[{id:`default`,name:`All Formulas`}]).map(e=>({id:e.id,name:e.name})),r=null,i=!1,a=null,o=null;function s(){d.set(`vault_folders`,n)}function c(e){let t=d.getVault();return e===`default`?t:t.filter(t=>t.folderId===e)}function l(){let t=d.getVault();e.innerHTML=`
      <div class="page__container">
        ${r?_(r,t):u(t)}
      </div>
      ${v()}
    `,Zd(),b(t)}function u(e){return`
...
Respond in EXACTLY this JSON format (no markdown, no code blocks):
{
  ...
  "scentDescription": "Vivid 2-sentence sensory preview"
    ...
    `,cf(),e.querySelectorAll(`.community-sort-btn`).forEach(e=>{e.addEventListener(`click`,()=>{i=e.dataset.sort,_()})}),e.querySelectorAll(`.community-interact-btn`).forEach(e=>{e.addEventListener(`click`,t=>{t.stopPropagation();let r=e.dataset.id,i=n.find(e=>e.id===r);i&&sf(i)})}),e.querySelectorAll(`.community-trending-item`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.id,r=n.find(e=>e.id===t);r&&sf(r)})});let r=e.querySelector(`#btn-load-suggestion`);r&&r.addEventListener(`click`,()=>{if(c?.layers?.length){let e=c.layers.map(e=>e.perfumeId).filter(e=>y(e));sessionStorage.setItem(`labPending`,JSON.stringify(e)),t(`#lab`)}})}_(),c||v();async function v(){let e=b();if(hd()){let t=await ef();c=t.success&&t.remix?t.remix:e}else c=e;l=!1,f(c),_()}function b(){let e=h.slice().sort((e,t)=>t.matchPercent-e.matchPercent)[0]||n[0];return{remixName:e?.name||`Daily Selection`,layers:e?.layers||[],inspiration:e?.description||`A community-loved formula selected for your profile.`,scentDescription:`Balanced for versatility across day and evening wear.`}}}function rf(e,t){return t?`
    ...
    <div class="ai-response">
      ...
      <div class="ai-response__text">
        ...
        `:``}
        ${e.inspiration?`<p><strong>Inspiration:</strong> ${af(e.inspiration,3)}</p>`:``}
        ${e.scentDescription?`<p><em>${af(e.scentDescription,1)}</em></p>`:``}
      </div>
    </div>
    <div class="flex gap-sm mt-md">
      <button class="btn btn--primary btn--sm" id="btn-load-suggestion">Load to Lab</button>
    </div>
  `:`<p style="font-size: var(--text-sm); color: var(--text-tertiary);">No suggestion available yet.</p>`}function af(e,t=3){return e?(e.match(/[^.!?]+[.!?]+|[^.!?]+$/g)||[]).slice(0,t).join(` `).trim():``}function of(e,t){return[1,2,3,4,5].map(n=>`<span class="cm-star cm-star-display ${n<=e?`cm-star--on`:``}" data-ci="${t}" data-val="${n}">★</span>`).join(``)}function sf(e){let t=JSON.parse(localStorage.getItem(`monaccord_comments_`+e.id)||`[]`),n=d.isLiked(e.id),r=document.createElement(`div`);r.className=`modal-overlay`,r.innerHTML=`
          ...
          ${t.length===0?`<p style="font-size: var(--text-xs); color: var(--text-tertiary);">No comments yet. Be the first!</p>`:t.map((e,t)=>`
              <div class="cm-comment" data-ci="${t}">
                <div class="cm-comment-meta">
                  ...
                  <span class="cm-stars">${of(e.rating||0,t)}</span>
  ...
  `,document.head.appendChild(e)}function lf(e,t){let n=[];function r(){let i=d.getOwnedPerfumes().monAccord||[],a=uf(i,n);e.innerHTML=`
      <div class="page__container">
            ...
            ${p.map(e=>{let t=m.filter(t=>t.region===e.id&&t.format===`spray`),r=m.filter(t=>t.region===e.id&&t.format===`oil`);return`
                <div class="shop-region-card" style="--region-color: ${e.color}; --region-light: ${e.colorLight};">
                  ...
                  <div class="shop-region-card__products">
                    ${[...t,...r].map(e=>{let t=n.find(t=>t.id===e.id),r=i.includes(e.id);return`
