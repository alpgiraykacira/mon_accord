...
`).filter(e=>e.trim()).filter(e=>!e.match(/^(OVERALL|SILLAGE)/i)).map(e=>{if(e.match(/^(OPENING|HEART|DRY DOWN)/i)){let t=e.indexOf(`:`);return`<p class="sim-section"><span class="sim-label">${e.substring(0,t).trim()}</span><span class="sim-body">${e.substring(t+1).trim()}</span></p>`}return`<p>${e}</p>`}).join(``):``}function Ve(){if(document.getElementById(`lab-styles`))return;let e=document.createElement(`style`);e.id=`lab-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e)}var He=`/mon_accord/assets/folder-DAYqs9Dj.webp`,Ue={scandinavian:new URL(`/mon_accord/assets/scandinavian-DvtLirp4.webp`,``+import.meta.url).href,eastasia:new URL(`/mon_accord/assets/east_asia-UzXNmAB4.webp`,``+import.meta.url).href,southafrica:new URL(`/mon_accord/assets/south_africa-PFpjigF9.webp`,``+import.meta.url).href,mediterranean:new URL(`/mon_accord/assets/mediterranean-CV0fuGZk.webp`,``+import.meta.url).href,southamerica:new URL(`/mon_accord/assets/south_america-DyzbduD3.webp`,``+import.meta.url).href,middleeast:new URL(`/mon_accord/assets/middle_east-Bmlf8LlT.webp`,``+import.meta.url).href},M={scandinavian:new URL(`/mon_accord/assets/scandinavian-BBoj4W5D.webp`,``+import.meta.url).href,eastasia:new URL(`/mon_accord/assets/east_asia-D93RVLet.webp`,``+import.meta.url).href,southafrica:new URL(`/mon_accord/assets/south_africa-hdHFYwXs.webp`,``+import.meta.url).href,mediterranean:new URL(`/mon_accord/assets/mediterranean-B_fMAvaC.webp`,``+import.meta.url).href,southamerica:new URL(`/mon_accord/assets/south_america-DcR51yl4.webp`,``+import.meta.url).href,middleeast:new URL(`/mon_accord/assets/middle_east-DMI8-64c.webp`,``+import.meta.url).href},We={"mugler-angel":new URL(`/mon_accord/assets/angel-JaKC4iyN.webp`,``+import.meta.url).href,"ysl-black-opium":new URL(`/mon_accord/assets/black_opium-CwBrp2qb.webp`,``+import.meta.url).href,"lancome-la-vie-est-belle":new URL(`/mon_accord/assets/la_vie_est_belle-CHGqLg72.webp`,``+import.meta.url).href},Ge=[`mugler-angel`,`ysl-black-opium`,`lancome-la-vie-est-belle`],Ke=[{id:`evening`,name:`Evening Wear`},{id:`daytime`,name:`Daytime`},{id:`office`,name:`Office`},{id:`weekend`,name:`Weekend`},{id:`seasonal`,name:`Seasonal`}],qe=[{id:`default-ev-1`,name:`Velvet Dusk`,folderId:`evening`,layers:[{perfumeId:`middleeast-spray`,amount:3,unit:`sprays`},{perfumeId:`southafrica-oil`,amount:2,unit:`drops`},{perfumeId:`scandinavian-oil`,amount:1,unit:`drops`}]},{id:`default-ev-2`,name:`Golden Night`,folderId:`evening`,layers:[{perfumeId:`southamerica-spray`,amount:3,unit:`sprays`},{perfumeId:`middleeast-oil`,amount:2,unit:`drops`}]},{id:`default-ev-3`,name:`Night Bloom`,folderId:`evening`,layers:[{perfumeId:`mediterranean-spray`,amount:2,unit:`sprays`},{perfumeId:`eastasia-oil`,amount:2,unit:`drops`},{perfumeId:`middleeast-oil`,amount:1,unit:`drops`}]},{id:`default-da-1`,name:`Fresh Morning`,folderId:`daytime`,layers:[{perfumeId:`scandinavian-spray`,amount:3,unit:`sprays`},{perfumeId:`mediterranean-oil`,amount:1,unit:`drops`}]},{id:`default-da-2`,name:`Sun Garden`,folderId:`daytime`,layers:[{perfumeId:`mediterranean-spray`,amount:2,unit:`sprays`},{perfumeId:`eastasia-spray`,amount:2,unit:`sprays`},{perfumeId:`scandinavian-oil`,amount:1,unit:`drops`}]},{id:`default-da-3`,name:`Coastal Breeze`,folderId:`daytime`,layers:[{perfumeId:`scandinavian-spray`,amount:2,unit:`sprays`},{perfumeId:`southamerica-spray`,amount:2,unit:`sprays`}]},{id:`default-da-4`,name:`Island Citrus`,folderId:`daytime`,layers:[{perfumeId:`southamerica-spray`,amount:3,unit:`sprays`},{perfumeId:`mediterranean-oil`,amount:1,unit:`drops`}]},{id:`default-of-1`,name:`Clean Presence`,folderId:`office`,layers:[{perfumeId:`scandinavian-spray`,amount:2,unit:`sprays`},{perfumeId:`eastasia-oil`,amount:1,unit:`drops`}]},{id:`default-of-2`,name:`Polished Air`,folderId:`office`,layers:[{perfumeId:`mediterranean-spray`,amount:2,unit:`sprays`},{perfumeId:`scandinavian-oil`,amount:1,unit:`drops`}]},{id:`default-we-1`,name:`Lazy Sunday`,folderId:`weekend`,layers:[{perfumeId:`southamerica-spray`,amount:3,unit:`sprays`},{perfumeId:`eastasia-oil`,amount:2,unit:`drops`}]},{id:`default-se-1`,name:`Winter Warmth`,folderId:`seasonal`,layers:[{perfumeId:`middleeast-spray`,amount:3,unit:`sprays`},{perfumeId:`southafrica-oil`,amount:2,unit:`drops`}]},{id:`default-se-2`,name:`Spring Bloom`,folderId:`seasonal`,layers:[{perfumeId:`mediterranean-spray`,amount:2,unit:`sprays`},{perfumeId:`scandinavian-spray`,amount:2,unit:`sprays`},{perfumeId:`eastasia-oil`,amount:1,unit:`drops`}]},{id:`default-se-3`,name:`Autumn Spice`,folderId:`seasonal`,layers:[{perfumeId:`southafrica-spray`,amount:2,unit:`sprays`},{perfumeId:`middleeast-oil`,amount:2,unit:`drops`}]}];function Je(e,n){if(!t.get(`vault_defaults_seeded`,!1)){let e=t.getVault(),n=new Set(e.map(e=>e.id)),r=Date.now();qe.forEach((t,i)=>{n.has(t.id)||e.push({...t,savedAt:r+i})}),t.set(`vault`,e),t.set(`vault_defaults_seeded`,!0)}let a=t.getOwnedPerfumes(),s=Ge.filter(e=>!a.loreal.includes(e));s.length&&(a.loreal=[...a.loreal,...s],t.setOwnedPerfumes(a));let c=t.get(`vault_folders`,null),u;if(!c)u=Ke.map(e=>({...e})),t.set(`vault_folders`,u);else{let e=c.filter(e=>e.id!==`default`),n=new Set(e.map(e=>e.id)),r=Ke.filter(e=>!n.has(e.id));u=[...e,...r].map(e=>({id:e.id,name:e.name})),t.set(`vault_folders`,u)}let d=null,f=!1,p=null,m=null;function h(){t.set(`vault_folders`,u)}function g(e){return t.getVault().filter(t=>t.folderId===e)}function _(){let n=t.getVault();e.innerHTML=`
    ...
    `}function y(){let e=t.getOwnedPerfumes();function n(e){return e.length?`<div class="vault-bottle-grid">
        ${e.map(e=>{let t=l(e),n=t?r.find(e=>e.id===t.region):null,i=t?.format===`spray`?Ue[t.region]:M[t.region],a=t?.name||e;return`
        ...
        ${e.map(e=>{let t=o.find(t=>t.id===e),n=We[e],r=t?t.name:e,i=t?.brand||``;return`
        ...
        <div class="vault-formulas-list">
          ${n.map(t=>{let n=t.layers||[];return`
              <div class="vault-formula-card" data-id="${t.id}">
                ...
                <div class="vault-formula-bottles">
                  ${n.map(e=>{let t=l(e.perfumeId),n=t?r.find(e=>e.id===t.region):null,i=t?.format===`spray`?Ue[t.region]:M[t.region];return`
                      <div class="vault-layer-bottle" style="--rc: ${n?.color||`var(--accent)`};">
                        <div class="vault-layer-bottle__wrap">
                      ...
                      <div class="vault-modal-bottle-row">
                        ...
                        ${r?`
                          <button class="vault-modal-bottle-btn vault-owned-add-btn ${o?`vault-modal-bottle-btn--owned`:``}"
                            ...
                            ${o?`disabled`:``}>
                            <img src="${M[t.id]}" alt="Oil" class="vault-modal-bottle-img" loading="lazy" decoding="async" />
...
Respond in EXACTLY this JSON format (no markdown, no code blocks):
{
  ...
  "scentDescription": "Vivid 2-sentence sensory preview"
        ...
        <div class="community-choice-row">
          <div class="community-choice-card">
            <div class="community-choice-card__photo-wrap">
              <img src="${et}" alt="Léna" class="community-choice-card__photo" loading="lazy" decoding="async" />
            </div>
          ...
          <div class="community-choice-card">
            <div class="community-choice-card__photo-wrap">
              <img src="${tt}" alt="Squeezie" class="community-choice-card__photo" loading="lazy" decoding="async" />
            </div>
          ...
          <div class="community-choice-card">
            <div class="community-choice-card__photo-wrap">
              <img src="${nt}" alt="Stéphanie" class="community-choice-card__photo" loading="lazy" decoding="async" />
            </div>
    ...
    `,ot(),k(n,i)}function te(e){let t=[...i.map(e=>({id:e.id,label:`${r.find(t=>t.id===e.region)?.icon||``} ${e.name} (${e.format})`,group:`Mon Accord`})),...o.map(e=>({id:e.id,label:`${e.brand} — ${e.name}`,group:`L'Oreal Luxe`}))];return`
  ...
  `:`<p style="font-size:var(--text-sm);color:var(--text-tertiary);padding:var(--space-lg);">No suggestion available.</p>`}function ot(){if(document.getElementById(`community-styles`))return;let e=document.createElement(`style`);e.id=`community-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e)}var st=`/mon_accord/assets/Sephora-Logo-0PIDe1Np.png`,ct=`/mon_accord/assets/Boyner_Logo-CbMLtvDJ.webp`,lt=`/mon_accord/assets/Trendyol_logo-CfMQtlYm.png`,ut=`/mon_accord/assets/hepsiburada-logo-I_Ul_zcU.png`,dt={scandinavian:new URL(`/mon_accord/assets/scandinavian-DvtLirp4.webp`,``+import.meta.url).href,eastasia:new URL(`/mon_accord/assets/east_asia-UzXNmAB4.webp`,``+import.meta.url).href,southafrica:new URL(`/mon_accord/assets/south_africa-PFpjigF9.webp`,``+import.meta.url).href,mediterranean:new URL(`/mon_accord/assets/mediterranean-CV0fuGZk.webp`,``+import.meta.url).href,southamerica:new URL(`/mon_accord/assets/south_america-DyzbduD3.webp`,``+import.meta.url).href,middleeast:new URL(`/mon_accord/assets/middle_east-Bmlf8LlT.webp`,``+import.meta.url).href},ft={scandinavian:new URL(`/mon_accord/assets/scandinavian-BBoj4W5D.webp`,``+import.meta.url).href,eastasia:new URL(`/mon_accord/assets/east_asia-D93RVLet.webp`,``+import.meta.url).href,southafrica:new URL(`/mon_accord/assets/south_africa-hdHFYwXs.webp`,``+import.meta.url).href,mediterranean:new URL(`/mon_accord/assets/mediterranean-B_fMAvaC.webp`,``+import.meta.url).href,southamerica:new URL(`/mon_accord/assets/south_america-DcR51yl4.webp`,``+import.meta.url).href,middleeast:new URL(`/mon_accord/assets/middle_east-DMI8-64c.webp`,``+import.meta.url).href};function pt(e,n){let a=t.getShopCart(),o=[...new Set(t.consumePendingShopCart())],s=[...new Set([...a,...o])],c=s.map(e=>({id:e}));if(o.length){let e=s.length-a.length;window.showToast(`Added ${e} new item${e===1?``:`s`} from your recommended combination.`)}u();function u(){t.setShopCart(c.map(e=>e.id))}function d(){let a=t.getOwnedPerfumes().monAccord||[];mt(a,c),e.innerHTML=`
                  ...
                  <div class="shop-region-card__products">
                    ${t?(()=>{let n=c.find(e=>e.id===t.id),r=a.includes(t.id);return`
                        <button class="shop-bottle-btn ${n?`shop-bottle-btn--in-cart`:``} ${r?`shop-bottle-btn--owned`:``}" data-id="${t.id}" style="--region-color:${e.color};">
                          ...
                          <img src="${dt[e.id]}" class="shop-bottle-img" alt="Spray" loading="lazy" decoding="async" />
                    ...
                    ${n?(()=>{let t=c.find(e=>e.id===n.id),r=a.includes(n.id);return`
                        <button class="shop-bottle-btn ${t?`shop-bottle-btn--in-cart`:``} ${r?`shop-bottle-btn--owned`:``}" data-id="${n.id}" style="--region-color:${e.color};">
                          ...
                          ${r?`<div class="shop-bottle-owned">Owned</div>`:``}
                          <img src="${ft[e.id]}" class="shop-bottle-img" alt="Oil" loading="lazy" decoding="async" />
    ...
    `,gt(),e.querySelectorAll(`.shop-bottle-btn`).forEach(e=>{e.addEventListener(`click`,t=>{t.stopPropagation();let n=e.dataset.id,r=c.findIndex(e=>e.id===n);r>=0?c.splice(r,1):c.push({id:n}),u(),d()})}),e.querySelectorAll(`.shop-cart__item-remove`).forEach(e=>{e.addEventListener(`click`,()=>{c=c.filter(t=>t.id!==e.dataset.id),u(),d()})});let o=e.querySelector(`#btn-confirm-order`);o&&o.addEventListener(`click`,()=>{ht(c,e,n)})}d()}function mt(e,t){if(!e.length)return null;let n=t.map(e=>e.id),r=e.map(e=>l(e)).filter(Boolean),a=[...new Set(r.flatMap(e=>e.scentFamily.split(`-`)))],o=i.filter(t=>!e.includes(t.id)&&!n.includes(t.id)&&t.scentFamily.split(`-`).some(e=>a.includes(e))).slice(0,2);return o.length?`Based on your owned ${r.map(e=>e.name).join(` & `)}: try adding ${o.map(e=>e.name).join(` or `)}.`:null}function ht(e,n,r){t.clearShopCart();let i=document.createElement(`div`);i.className=`modal-overlay`,i.innerHTML=`
        ...
        <div class="order-retailers">
          <div class="order-retailers__grid">
            <div class="order-retailer-card" aria-label="Sephora">
              <img src="${st}" alt="Sephora" class="order-retailer-card__logo" loading="lazy" decoding="async" />
            </div>
            <div class="order-retailer-card" aria-label="Boyner">
              <img src="${ct}" alt="Boyner" class="order-retailer-card__logo" loading="lazy" decoding="async" />
            </div>
            <div class="order-retailer-card" aria-label="Trendyol">
              <img src="${lt}" alt="Trendyol" class="order-retailer-card__logo" loading="lazy" decoding="async" />
            </div>
            <div class="order-retailer-card" aria-label="Hepsiburada">
              <img src="${ut}" alt="Hepsiburada" class="order-retailer-card__logo" loading="lazy" decoding="async" />
            </div>
          </div>
        </div>
  ...
  `,document.head.appendChild(e)}function P(e){return new Promise(t=>setTimeout(t,e))}function F(e,t){if(!e)return P(0);var n=t===void 0?90:t,r=e.getBoundingClientRect().top+window.scrollY-n;return window.scrollTo({top:Math.max(0,r),behavior:`smooth`}),P(700)}function _t(e,t,n){return Math.min(n,Math.max(t,e))}function vt(e){let t={};for(let n=0;n<e.length;n+=1){let r=e.key(n);r&&(t[r]=e.getItem(r))}return t}function yt(e,t){e.clear(),Object.entries(t||{}).forEach(([t,n])=>{n!=null&&e.setItem(t,n)})}async function bt(){let e=document.createElement(`div`);e.id=`dt-flash`,e.style.cssText=`
    position:fixed;inset:0;z-index:99994;
    background:rgba(200,169,126,0.07);
    pointer-events:none;opacity:0;
    transition:opacity 0.18s ease;
  `,document.body.appendChild(e),requestAnimationFrame(()=>requestAnimationFrame(()=>{e.style.opacity=`1`})),await P(210),e.style.opacity=`0`,setTimeout(()=>e.remove(),230)}async function I(e){window.location.hash!==e&&bt(),window.location.hash===e&&(window.location.hash=`#_nav`,await P(150)),window.location.hash=e,await P(450)}function L(e,t,n=2e3){return new Promise(r=>{let i=()=>document.querySelector(e)||(t?document.querySelector(t):null),a=i();if(a){r(a);return}let o=new MutationObserver(()=>{let e=i();e&&(o.disconnect(),clearTimeout(s),r(e))});o.observe(document.body,{childList:!0,subtree:!0});let s=setTimeout(()=>{o.disconnect(),r(document.getElementById(`page-content`)||document.body)},n)})}var xt={username:`Alp`,archetypeName:`The Elegant Minimalist`,description:`You are drawn to understated sophistication - scents that whisper rather than shout. Your olfactory identity is defined by clean precision, refined florals, and the quiet depth of woody bases. You seek harmony, not performance.`,primaryFamilies:[`floral`,`woody`,`citrus`],sillageProfile:`Medium - intimate yet memorable, discovered only in close proximity.`,notePreferences:{loves:[`iris`,`sandalwood`,`bergamot`,`white musk`],explore:[`oud`,`rose`,`vetiver`,`ambergris`],avoid:[`heavy synthetics`,`excessive sweetness`,`dense patchouli`]},recommendedRegions:[`scandinavian`,`mediterranean`,`eastasia`],updatedAt:Date.now()},St=`monaccord_profile`,Ct=`monaccord_quiz_state`,R=``,z=null,B=null,V=void 0,H=[{title:`Mon Accord`,run:async()=>(await I(`#landing`),window.scrollTo({top:0,behavior:`auto`}),await L(`#hero-section .hero__content`,`#hero-section`,2e3)),duration:3500},{title:`Six World Regions`,run:async()=>{let e=document.querySelector(`#regions-section`);return e&&await F(e,60),document.querySelector(`.region-card`)||e||document.querySelector(`.page__container`)},duration:4e3},{title:`Spray & Oil Notes`,run:async()=>(document.querySelector(`.notes-popup`)?.remove(),document.querySelector(`.region-format-btn[data-format="spray"]`)?.click(),await P(250),document.querySelector(`.notes-popup`)?.scrollIntoView({behavior:`smooth`,block:`nearest`}),await P(300),document.querySelector(`.notes-popup__inner`)||document.querySelector(`#regions-section`)),duration:4e3},{title:`Take the Quiz`,samePage:!0,run:async()=>{document.querySelector(`.notes-popup`)?.remove();let e=document.querySelector(`#cta-section`);e?e.scrollIntoView({behavior:`smooth`,block:`center`}):window.scrollTo({top:document.body.scrollHeight,behavior:`smooth`}),await P(700);let t=document.querySelector(`#bottom-cta`);return t&&(t.scrollIntoView({behavior:`smooth`,block:`center`}),await P(500)),t||document.querySelector(`#cta-section`)||document.querySelector(`.page__container`)},duration:3e3},{title:`Step 1 - Your Name`,run:async()=>{document.querySelector(`.notes-popup`)?.remove(),localStorage.removeItem(Ct),window.__retakeQuiz=!0,await I(`#profile`);let e=await L(`.quiz-container`,`.page__container`,2500);await P(300);let t=document.querySelector(`#quiz-username`);if(t){t.focus();for(let e of`Alp`)t.value+=e,t.dispatchEvent(new Event(`input`)),await P(120)}return e},duration:2500},{title:`Step 2 - Scent Families`,run:async()=>{document.querySelector(`#quiz-next`)?.click(),await P(400);let e=[...document.querySelectorAll(`.quiz-grid--families .quiz-option`)];for(let t of e.slice(0,3))t.click(),await P(280);return document.querySelector(`.quiz-grid--families`)||document.querySelector(`.quiz-container`)},duration:2500},{title:`Step 3 - Perfumes You Love`,run:async()=>{document.querySelector(`#quiz-next`)?.click(),await P(450);let e=[...document.querySelectorAll(`.quiz-option--perfume`)];for(let t of e.slice(0,2))t.click(),await P(220);return document.querySelector(`.quiz-perfume-list`)||document.querySelector(`.quiz-container`)},duration:2500},{title:`Step 4 - Performance`,run:async()=>{document.querySelector(`#quiz-next`)?.click(),await P(400);for(let e of[{id:`slider-sillage`,valId:`sillage-val`,target:7},{id:`slider-longevity`,valId:`longevity-val`,target:10},{id:`slider-intensity`,valId:`intensity-val`,target:5}]){let t=document.querySelector(`#`+e.id);t&&(t.value=e.target,t.dispatchEvent(new Event(`input`,{bubbles:!0})),await P(350))}return document.querySelector(`.quiz-sliders`)||document.querySelector(`.quiz-container`)},duration:2500},{title:`Step 5 - Your Personality`,run:async()=>{document.querySelector(`#quiz-next`)?.click(),await P(400),(document.querySelector(`[id="ctx-elegant"]`)||document.querySelector(`.quiz-grid--context .quiz-option`))?.click(),await P(300);let e=document.querySelector(`#quiz-notes`);if(e){e.focus();for(let t of`I love the scent of fresh linen and evening air.`)e.value+=t,e.dispatchEvent(new Event(`input`)),await P(38)}return document.querySelector(`.quiz-grid--context`)||document.querySelector(`.quiz-container`)},duration:5500},{title:`Your Olfactory Profile`,run:async()=>(localStorage.setItem(St,JSON.stringify(xt)),localStorage.setItem(`monaccord_my_perfumes`,JSON.stringify({monAccord:[`scandinavian-spray`,`eastasia-spray`,`mediterranean-oil`],loreal:[`ysl-libre`,`ysl-black-opium`]})),window.__retakeQuiz=!1,window.dispatchEvent(new Event(`hashchange`)),await P(500),window.scrollTo({top:0,behavior:`auto`}),await L(`.profile-result`,`.page__container`,3e3),document.querySelector(`.section-header`)||document.querySelector(`.profile-result`)||document.querySelector(`.page__container`)),duration:4e3},{title:`Identity & Preferences`,run:async()=>{let e=document.querySelector(`.profile-overview`),t=document.querySelector(`.profile-details`)||e;return await F(e),t||document.querySelector(`.profile-result`)},duration:4e3},{title:`Mon Accord Combinations`,run:async()=>{let e=document.querySelectorAll(`.recommendation-grid`)[0],t=e?.previousElementSibling?.previousElementSibling||e,n=e?.querySelector(`.combo-card`)||e;return await F(t||n,80),n||document.querySelector(`.profile-result`)},duration:4e3},{title:`L'Oreal Luxe Combinations`,run:async()=>{let e=document.querySelectorAll(`.recommendation-grid`),t=e.length>1?e[1]:e[0],n=t?.previousElementSibling?.previousElementSibling||t,r=t?.querySelector(`.combo-card`)||t;return await F(n||r,80),r||document.querySelector(`.profile-result`)},duration:4e3},{title:`Shop - Build Your Collection`,run:async()=>{let e=document.querySelector(`[data-buy-combo]`);return e?(e.click(),await P(600)):await I(`#shop`),await L(`.shop-region-card`,`.shop-layout`,2e3)},duration:4e3},{title:`Add to Cart`,run:async()=>{let e=[...document.querySelectorAll(`.shop-product__btn:not(.shop-product__btn--added)`)];e[0]&&(e[0].click(),await P(180)),e[1]&&(e[1].click(),await P(180));let t=document.querySelector(`.shop-cart`);return t?.scrollIntoView({behavior:`smooth`,block:`center`}),await P(300),t||document.querySelector(`.page__container`)},duration:4e3},{title:`Now Available`,run:async()=>(document.querySelector(`#btn-confirm-order`)?.click(),await P(350),document.querySelector(`.order-confirmed-modal`)||document.querySelector(`.modal-overlay`)||document.querySelector(`.page__container`)),duration:4e3},{title:`The Layering Lab`,run:async()=>{document.querySelector(`.modal-overlay`)?.remove(),await I(`#lab`),window.scrollTo({top:0,behavior:`auto`}),await P(200);let e=[...document.querySelectorAll(`.lab-add-btn:not(.lab-add-btn--added)`)];return e[0]&&(e[0].click(),await P(200)),e[2]&&(e[2].click(),await P(200)),await P(300),document.querySelector(`#lab-layers`)||document.querySelector(`#lab-add-section`)},duration:5e3},{title:`Virtual Scent Simulation`,samePage:!0,run:async()=>{let e=document.querySelector(`#btn-simulate`);e&&(await F(e),e.innerHTML=`<span class=”loading-spinner”></span> Simulating...`,e.disabled=!0,await P(1200),e.innerHTML=`✦ Simulate Scent`,e.disabled=!1);let t=document.querySelector(`#simulation-result`);if(!t){t=document.createElement(`div`),t.id=`simulation-result`,t.className=`ai-response mt-lg`;let e=document.querySelector(`#lab-actions`);e?e.insertAdjacentElement(`afterend`,t):document.querySelector(`#lab-layers`)?.appendChild(t)}return t&&(t.style.display=``,t.innerHTML=`
        ...
        `,await F(t)),t||document.querySelector(`#lab-layers`)||document.querySelector(`.page__container`)},duration:4500},{title:`Contextual Advisor`,run:async()=>{let e=document.querySelector(`.lab-advisor`);await F(e),document.querySelector(`#mood-chips .lab-chip`)?.click(),await P(100),document.querySelector(`#occasion-chips .lab-chip`)?.click(),await P(100),document.querySelector(`#season-chips .lab-chip`)?.click(),await P(250);let t=document.querySelector(`#advisor-result`);return t||(t=document.createElement(`div`),t.id=`advisor-result`,t.className=`lab-advisor__result mt-lg`,document.querySelector(`.lab-advisor__form`)?.insertAdjacentElement(`afterend`,t)),t&&(t.style.display=``,t.innerHTML=`
        ...
        `),t||document.querySelector(`.lab-advisor__form`)||e||document.querySelector(`.page__container`)},duration:5e3},{title:`Save to Vault`,samePage:!0,run:async()=>{let e=await L(`#btn-save-formula`,`.page__container`,1200);e&&e.id===`btn-save-formula`&&(await F(e),e.click(),await P(450));let t=await L(`#save-vault-overlay .modal`,`#save-vault-overlay`,2e3),n=document.querySelector(`#sv-name`);if(n){n.value=``,n.focus();for(let e of`Evening Velvet`)n.value+=e,n.dispatchEvent(new Event(`input`)),await P(55);await P(300)}let r=document.querySelector(`#sv-folder-dropdown`);if(r){let e=[...r.options].find(e=>e.value===`evening`||e.text.toLowerCase().includes(`evening`));e&&(r.value=e.value,r.dispatchEvent(new Event(`change`))),await P(400)}return t||document.querySelector(`#save-vault-overlay`)||document.querySelector(`.page__container`)},duration:4500},{title:`Your Vault`,run:async()=>(document.querySelector(`#sv-confirm`)?.click(),await P(350),await I(`#vault`),await L(`.vault-folders-col`,`.page__container`,2e3)),duration:4e3},{title:`My Perfumes`,samePage:!0,run:async()=>{let e=document.querySelector(`.vault-myperfumes-col`);return window.scrollTo({top:0,behavior:`smooth`}),await P(400),e||document.querySelector(`.vault-main-layout`)||document.querySelector(`.page__container`)},duration:4e3},{title:`Trending Combinations`,run:async()=>{await I(`#community`);let e=document.querySelector(`.duygu-card__photo`);return e&&!e.complete&&await new Promise(t=>{e.onload=t,e.onerror=t,setTimeout(t,3e3)}),await P(200),await L(`.community-trending-item`,`.community-trending-list`,2e3)},duration:4e3},{title:`Today's Selection`,samePage:!0,run:async()=>{let e=document.querySelector(`.community-panel--selection`);return await F(e),e||document.querySelector(`.community-top-grid`)||document.querySelector(`.page__container`)},duration:4e3},{title:`Duygu's Choice`,samePage:!0,run:async()=>{let e=document.querySelector(`.community-duygu-choice`);return e?(await F(e),e):document.querySelector(`.community-right-col`)||document.querySelector(`.page__container`)},duration:4e3},{title:`Community Discussion`,samePage:!0,run:async()=>{let e=document.querySelector(`.community-discussion-section`);return await F(e,60),document.querySelector(`.community-post-item`)?.click(),await P(300),document.querySelector(`.community-discussion-layout`)||e||document.querySelector(`.page__container`)},duration:4500}],wt=[3e3,3500,3500,3e3,2500,2500,2500,2500,5e3,4500,3e3,4e3,3e3,3500,3500,3500,4500,4500,4e3,3500,3500,3500,3500,3e3,3500,3500];H.forEach((e,t)=>{e.duration=wt[t]??e.duration});function Tt(){return document.getElementById(`dt-card`)}function Et(){return document.getElementById(`dt-prog`)}function Dt(){return document.getElementById(`dt-cd`)}function Ot(){return document.getElementById(`dt-dots`)}function kt(){return document.getElementById(`dt-count`)}function At(){return document.getElementById(`dt-title`)}function jt(){return document.getElementById(`dt-next`)}var Mt=24,U=20;function Nt(e){let t=Tt();if(!t)return;let n=window.innerWidth,r=window.innerHeight,i=Mt,a=Math.min(t.offsetWidth||288,n-i*2),o=t.offsetHeight||126,s=e?e.getBoundingClientRect():null;if(!s||(s.width||0)===0||(s.height||0)===0||s.bottom<=0||s.top>=r||s.right<=0||s.left>=n){let e=Math.min(n-i*2,320),t=Math.min(r-i*2,160);s={left:(n-e)/2,top:(r-t)/2,right:(n+e)/2,bottom:(r+t)/2}}let c=s.right-s.left,l=s.bottom-s.top,u=[{placement:`bottom`,x:s.left+(c-a)/2,y:s.bottom+U},{placement:`top`,x:s.left+(c-a)/2,y:s.top-o-U},{placement:`right`,x:s.right+U,y:s.top+(l-o)/2},{placement:`left`,x:s.left-a-U,y:s.top+(l-o)/2},{placement:`bottom-right`,x:s.right-a,y:s.bottom+U},{placement:`bottom-left`,x:s.left,y:s.bottom+U},{placement:`top-right`,x:s.right-a,y:s.top-o-U},{placement:`top-left`,x:s.left,y:s.top-o-U}];function d(e){let t=_t(e.x,i,Math.max(i,n-a-i)),s=_t(e.y,i,Math.max(i,r-o-i));return{placement:e.placement,left:t,top:s,right:t+a,bottom:s+o,clampDelta:Math.abs(e.x-t)+Math.abs(e.y-s)}}function f(e){let t=(e.left+e.right)/2,n=(e.top+e.bottom)/2,r=(s.left+s.right)/2,i=(s.top+s.bottom)/2;return Math.hypot(t-r,n-i)}function p(e){let t=Math.max(e.left,s.left),n=Math.max(e.top,s.top),r=Math.min(e.right,s.right),i=Math.min(e.bottom,s.bottom);return r>t&&i>n?(r-t)*(i-n):0}let m=u.map(e=>{let t=d(e);return{rect:t,score:p(t)*4+f(t)+t.clampDelta*6}}).sort((e,t)=>e.score-t.score)[0];t.dataset.placement=m.rect.placement,t.style.transform=`translate(${Math.round(m.rect.left)}px, ${Math.round(m.rect.top)}px)`}function Pt(e){let t=H[e],n=H.length,r=kt(),i=At(),a=Ot(),o=Et(),s=jt();if(r&&(r.textContent=`${String(e+1).padStart(2,`0`)} / ${String(n).padStart(2,`0`)}`),i&&(i.textContent=t.title),o&&(o.style.width=`${(e+1)/n*100}%`),s&&(s.textContent=e===n-1?`Finish`:`Next`),a){let t=Math.min(n,12),r=Math.max(0,e-Math.floor(t/2));a.innerHTML=Array.from({length:t},(t,n)=>{let i=n+r;return`<span class="dt-dot ${i===e?`dt-dot--active`:i<e?`dt-dot--done`:`dt-dot--pending`}"></span>`}).join(``)}}var W=null;function Ft(e){clearInterval(W);let t=Dt();if(!t)return;t.style.width=`0%`;let n=Date.now();W=setInterval(()=>{let r=Math.min(100,(Date.now()-n)/e*100);t.style.width=r+`%`,r>=100&&clearInterval(W)},40)}var G=!1,K=0,q=null;async function It(e){if(!G)return;K=e;let t=H[e];Pt(e);let n;try{n=await t.run()}catch{n=document.getElementById(`page-content`)||document.body}G&&(Nt(n),Ft(t.duration),clearTimeout(q),q=setTimeout(()=>Lt(),t.duration))}function Lt(){G&&(clearTimeout(q),K>=H.length-1?J():It(K+1))}function Rt(){zt(),Vt();let e=document.createElement(`div`);e.id=`dt-card`,e.innerHTML=`
  ...
  `,document.body.appendChild(e),document.getElementById(`dt-skip`).addEventListener(`click`,J),document.getElementById(`dt-next`).addEventListener(`click`,()=>{clearTimeout(q),clearInterval(W),Lt()})}function zt(){document.getElementById(`dt-card`)?.remove(),document.getElementById(`dt-flash`)?.remove()}function Bt(){G&&J(),R=window.location.hash||``,z=vt(localStorage),B=vt(sessionStorage),V=window.__retakeQuiz,localStorage.clear(),sessionStorage.clear(),delete window.__retakeQuiz,localStorage.removeItem(St),G=!0,K=0,Rt(),It(0)}function J(){G=!1,clearTimeout(q),clearInterval(W),yt(localStorage,z),yt(sessionStorage,B),z=null,B=null,V===void 0?delete window.__retakeQuiz:window.__retakeQuiz=V,V=void 0,(R||``)!==(window.location.hash||``)&&(window.location.hash=R||`#landing`),R=``,zt()}function Vt(){if(document.getElementById(`dt-styles`))return;let e=document.createElement(`style`);e.id=`dt-styles`,e.textContent=`
    #dt-card {
      position: fixed;
      z-index: 99995;
      top: 0;
  ...
  `,document.head.appendChild(e)}function Y(e){return new Promise(t=>setTimeout(t,e))}function X(){if(document.getElementById(`pd-styles`))return;let e=document.createElement(`style`);e.id=`pd-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e)}function Z(e){(Array.isArray(e)?e:[e]).forEach(e=>{e.classList.remove(`pd-highlight--out`),e.classList.add(`pd-highlight`)})}async function Q(e){let t=Array.isArray(e)?e:[e];t.forEach(e=>{e.classList.remove(`pd-highlight`),e.classList.add(`pd-highlight--out`)}),await Y(900),t.forEach(e=>e.classList.remove(`pd-highlight--out`))}function Ht(e){e.classList.remove(`pd-highlight-inner--out`),e.classList.add(`pd-highlight-inner`)}async function Ut(e){e.classList.remove(`pd-highlight-inner`),e.classList.add(`pd-highlight-inner--out`),await Y(900),e.classList.remove(`pd-highlight-inner--out`)}async function Wt(){X();let e=document.querySelector(`.profile-hero`),t=document.querySelector(`.profile-summary-card`);if(!e||!t)return;function n(e,t=1.05){e.style.transition=`transform 0.7s cubic-bezier(0.25,0.46,0.45,0.94)`,e.style.transformOrigin=`top center`,e.style.transform=`scale(${t})`}function r(e){e.style.transform=`scale(1)`}async function i(e){await Y(600),e.style.transform=``,e.style.transition=``,e.style.transformOrigin=``}window.scrollTo({top:0,behavior:`auto`}),await Y(2e3),t.scrollIntoView({behavior:`smooth`,block:`nearest`}),await Y(500),n(t,1.04),Z(t),await Y(3e3),r(t),await Q(t),await i(t);let a=document.querySelectorAll(`.recommendation-grid`),o=a[0];if(!o)return;let s=o.closest(`.mt-xl`)||o.parentElement,c=(s||o).getBoundingClientRect().top+window.scrollY-80;window.scrollTo({top:Math.max(0,c),behavior:`smooth`}),await Y(700),s&&(n(s,1.03),Z(s),await Y(3e3),r(s),await Q(s),await i(s));let l=a[1]?.closest(`.mt-xl`)||a[1]?.parentElement;if(l){let e=l.getBoundingClientRect().top+window.scrollY-80;window.scrollTo({top:Math.max(0,e),behavior:`smooth`}),await Y(500),n(l,1.03),Z(l),await Y(3e3),r(l),await Q(l),await i(l)}}async function Gt(){X(),window.scrollTo({top:0,behavior:`auto`}),await Y(2e3);let e=document.querySelector(`.lab-advisor`);if(e){let t=e.getBoundingClientRect().top+window.scrollY-90;window.scrollTo({top:Math.max(0,t),behavior:`smooth`})}await Y(700);for(let[e,t]of[[`#mood-chips`,`romantic`],[`#occasion-chips`,`date-night`],[`#season-chips`,`autumn`],[`#time-chips`,`evening`]])document.querySelector(`${e} [data-value="${t}"]`)?.click(),await Y(450);let t=document.querySelector(`#advisor-intensity`);t&&(t.value=7,t.dispatchEvent(new Event(`input`,{bubbles:!0}))),await Y(500);let n=document.querySelector(`#btn-get-advice`);n&&(n.innerHTML=`<span class="loading-spinner"></span> Crafting...`,n.disabled=!0),await Y(1100),window.__labSetDemoContext?.({formulaName:`Evening Accord`,reasoning:`A confident, romantic blend for a date night — woody base anchors the floral heart.`,scentPreview:`Opens with bergamot, blooms into iris, settles into warm sandalwood.`,tips:`Apply to pulse points for intimate sillage.`,layers:[{perfumeId:`scandinavian-spray`,amount:3,unit:`sprays`},{perfumeId:`mediterranean-spray`,amount:2,unit:`sprays`},{perfumeId:`eastasia-oil`,amount:2,unit:`drops`}]}),await Y(150);let r=document.querySelector(`#advisor-result`);if(r){let e=r.getBoundingClientRect().top+window.scrollY-90;window.scrollTo({top:Math.max(0,e),behavior:`smooth`}),await Y(700),Z(r),await Y(1500),await Q(r),await Y(300),document.querySelector(`#btn-apply-recommendation`)?.click(),await Y(500)}await Y(300);let i=document.querySelector(`.lab-canvas`);i&&(i.scrollIntoView({behavior:`smooth`,block:`start`}),await Y(600),Z(i),await Y(1e3),await Q(i));let a=document.querySelector(`#btn-simulate`);a&&(a.innerHTML=`<span class="loading-spinner"></span> Simulating...`,a.disabled=!0),await Y(1e3);let o=document.querySelector(`#simulation-result`),s=document.querySelector(`#lab-actions`);!o&&s&&(o=document.createElement(`div`),o.id=`simulation-result`,o.className=`ai-response mt-lg`,o.style.margin=`0 6px`,s.insertAdjacentElement(`afterend`,o)),o&&(o.innerHTML=`
      <div class="ai-response__label">✦ Virtual Scent Simulation</div>
      <div class="ai-response__text">
    ...
    `),a&&(a.innerHTML=`✦ Simulate Scent`,a.disabled=!1),await Y(200),o&&(i?i.scrollTo({top:i.scrollHeight,behavior:`smooth`}):o.scrollIntoView({behavior:`smooth`,block:`center`}),await Y(700),o.style.margin=`0 6px`,Ht(o),await Y(1800),await Ut(o)),await Y(400),document.querySelector(`#btn-clear-layers`)?.click(),await Y(500);let c=document.querySelector(`#lab-add-section`);if(c){let e=c.getBoundingClientRect().top+window.scrollY-80;window.scrollTo({top:Math.max(0,e),behavior:`smooth`}),await Y(700);for(let e of[`middleeast-spray`,`southamerica-spray`,`southafrica-oil`]){let t=document.querySelector(`.lab-bottle-btn[data-id="${e}"]`);t&&(t.click(),await Y(400))}}}async function Kt(){X(),window.__vaultForceReseed?.(),await Y(200),window.scrollTo({top:0,behavior:`auto`}),await Y(2e3);let e=document.querySelector(`.vault-folders-grid`);e&&(window.scrollTo({top:0,behavior:`smooth`}),await Y(500),e.style.transition=`transform 0.7s cubic-bezier(0.25,0.46,0.45,0.94)`,e.style.transformOrigin=`top center`,e.style.transform=`scale(1.06)`,Z(e),await Y(3e3),e.style.transform=`scale(1)`,await Q(e),await Y(600),e.style.transform=``,e.style.transition=``,e.style.transformOrigin=``);let t=document.querySelector(`.vault-myperfumes-col`);t&&(t.scrollIntoView({behavior:`smooth`,block:`center`}),await Y(600),t.style.transition=`transform 0.7s cubic-bezier(0.25,0.46,0.45,0.94)`,t.style.transformOrigin=`top center`,t.style.transform=`scale(1.04)`,Z(t),await Y(3e3),t.style.transform=`scale(1)`,await Q(t),await Y(600),t.style.transform=``,t.style.transition=``,t.style.transformOrigin=``)}async function qt(){X(),window.scrollTo({top:0,behavior:`auto`}),await Y(2e3);function e(e,t=1.05){e.style.transition=`transform 0.7s cubic-bezier(0.25,0.46,0.45,0.94)`,e.style.transformOrigin=`top center`,e.style.transform=`scale(${t})`}function t(e){e.style.transform=`scale(1)`}async function n(e){await Y(600),e.style.transform=``,e.style.transition=``,e.style.transformOrigin=``}let r=document.querySelector(`.community-panel:not(.community-panel--selection)`);r&&(r.scrollIntoView({behavior:`smooth`,block:`nearest`}),window.scrollTo({top:0,behavior:`smooth`}),await Y(500),e(r,1.04),Z(r),await Y(3e3),t(r),await Q(r),await n(r));let i=document.querySelector(`.community-panel--selection`);i&&(i.scrollIntoView({behavior:`smooth`,block:`nearest`}),await Y(500),e(i,1.04),Z(i),await Y(3e3),t(i),await Q(i),await n(i));let a=document.querySelector(`.community-choice-row`);a&&(a.scrollIntoView({behavior:`smooth`,block:`center`}),await Y(600),e(a,1.03),Z(a),await Y(3e3),t(a),await Q(a),await n(a));let o=document.querySelector(`.community-discussion-section`);if(o){o.scrollIntoView({behavior:`smooth`,block:`end`}),await Y(600);let e=[...document.querySelectorAll(`.community-post-item`)];e.length&&(e[Math.floor(Math.random()*Math.min(e.length,5))].click(),await Y(400)),await Y(4e3)}}var Jt={"#profile":Wt,"#lab":Gt,"#vault":Kt,"#community":qt};function Yt(e){return e in Jt}function Xt(e){let t=Jt[e];if(!t){window.showToast?.(`Bu sayfa için demo mevcut değil.`,`info`);return}t().catch(e=>console.error(`[page-demo]`,e))}var Zt=document.getElementById(`app`);function $(e){document.documentElement.setAttribute(`data-theme`,e),t.set(`theme`,e)}function Qt(){let e=t.get(`theme`,`dark`);document.documentElement.setAttribute(`data-theme`,e)}var $t={"":f,"#landing":f,"#profile":fe,"#lab":Re,"#vault":Je,"#shop":pt,"#community":it};function en(){return window.location.hash||``}function tn(e){window.location.hash=e}function nn(){let e=en(),t=$t[e]||f;Zt.innerHTML=``,Zt.appendChild(n(tn,e));let r=document.createElement(`div`);if(r.className=`page page-enter`,r.id=`page-content`,t(r,tn),Zt.appendChild(r),!document.querySelector(`.toast-container`)){let e=document.createElement(`div`);e.className=`toast-container`,e.id=`toast-container`,document.body.appendChild(e)}window.scrollTo({top:0,behavior:`auto`})}window.showToast=function(e,t=`success`){let n=document.getElementById(`toast-container`);if(!n)return;let r=document.createElement(`div`);r.className=`toast toast--${t}`,r.innerHTML=`<span class="toast__message">${e}</span>`,n.appendChild(r),setTimeout(()=>{r.style.animation=`fadeOut 0.3s var(--ease-out) forwards`,setTimeout(()=>r.remove(),300)},3e3)},window.showSettings=function(){let e=document.querySelector(`.modal-overlay`);e&&e.remove();let n=t.get(`theme`,`dark`),r=document.createElement(`div`);r.className=`modal-overlay`,r.id=`settings-modal`,r.innerHTML=`
    <div class="modal">
      <div class="modal__header">
      ...
      <div class="modal__body">
        ...
        <div class="input-group" style="margin-top:var(--space-lg); padding-top:var(--space-lg); border-top:1px solid var(--border);">
          ...
          <div style="display:flex; flex-direction:column; gap:var(--space-sm);">
            ...
            ${Yt(en())?`<button class="btn btn--primary btn--sm" id="settings-page-demo-btn" style="margin-top:2px;">▶ Bulunduğun Sayfanın Demosunu Başlat</button>`:``}
          </div>
        </div>
