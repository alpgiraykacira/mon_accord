...
Respond in EXACTLY this JSON format (no markdown, no code blocks):
{
  ...
  "scentDescription": "Vivid 2-sentence sensory preview"
        ...
        <div class="community-choice-row">
          <div class="community-choice-card">
            <div class="community-choice-card__photo-wrap">
              <img src="${Xe}" alt="Duygu" class="community-choice-card__photo" loading="lazy" decoding="async" />
            </div>
          ...
          <div class="community-choice-card">
            <div class="community-choice-card__photo-wrap">
              <img src="${Ze}" alt="Jack" class="community-choice-card__photo" loading="lazy" decoding="async" />
            </div>
            ...
            <div class="community-choice-card__combo">
              <div class="community-choice-card__layer">
                <span style="color:${r.find(e=>e.id===`southafrica`)?.color};">South Africa — Spray</span>
          ...
          <div class="community-choice-card">
            <div class="community-choice-card__photo-wrap">
              <img src="${Qe}" alt="Naomi" class="community-choice-card__photo" loading="lazy" decoding="async" />
            </div>
            ...
            <div class="community-choice-card__combo">
              <div class="community-choice-card__layer">
                <span style="color:${r.find(e=>e.id===`middleeast`)?.color};">Middle East — Spray</span>
                <span class="community-choice-card__amount">2 sprays</span>
              </div>
              <div class="community-choice-card__layer">
    ...
    `,nt(),k(n,i)}function te(e){let t=[...i.map(e=>({id:e.id,label:`${r.find(t=>t.id===e.region)?.icon||``} ${e.name} (${e.format})`,group:`Mon Accord`})),...o.map(e=>({id:e.id,label:`${e.brand} — ${e.name}`,group:`L'Oreal Luxe`}))];return`
  ...
  `:`<p style="font-size:var(--text-sm);color:var(--text-tertiary);padding:var(--space-lg);">No suggestion available.</p>`}function nt(){if(document.getElementById(`community-styles`))return;let e=document.createElement(`style`);e.id=`community-styles`,e.textContent=`
  ...
  `,document.head.appendChild(e)}var rt=`/mon_accord/assets/Sephora-Logo-0PIDe1Np.png`,it=`/mon_accord/assets/Boyner_Logo-CbMLtvDJ.webp`,at=`/mon_accord/assets/Trendyol_logo-CfMQtlYm.png`,ot=`/mon_accord/assets/hepsiburada-logo-I_Ul_zcU.png`,st={scandinavian:new URL(`/mon_accord/assets/scandinavian-DvtLirp4.webp`,``+import.meta.url).href,eastasia:new URL(`/mon_accord/assets/east_asia-UzXNmAB4.webp`,``+import.meta.url).href,southafrica:new URL(`/mon_accord/assets/south_africa-PFpjigF9.webp`,``+import.meta.url).href,mediterranean:new URL(`/mon_accord/assets/mediterranean-CV0fuGZk.webp`,``+import.meta.url).href,southamerica:new URL(`/mon_accord/assets/south_america-DyzbduD3.webp`,``+import.meta.url).href,middleeast:new URL(`/mon_accord/assets/middle_east-Bmlf8LlT.webp`,``+import.meta.url).href},ct={scandinavian:new URL(`/mon_accord/assets/scandinavian-BBoj4W5D.webp`,``+import.meta.url).href,eastasia:new URL(`/mon_accord/assets/east_asia-D93RVLet.webp`,``+import.meta.url).href,southafrica:new URL(`/mon_accord/assets/south_africa-hdHFYwXs.webp`,``+import.meta.url).href,mediterranean:new URL(`/mon_accord/assets/mediterranean-B_fMAvaC.webp`,``+import.meta.url).href,southamerica:new URL(`/mon_accord/assets/south_america-DcR51yl4.webp`,``+import.meta.url).href,middleeast:new URL(`/mon_accord/assets/middle_east-DMI8-64c.webp`,``+import.meta.url).href};function lt(e,n){let a=t.getShopCart(),o=[...new Set(t.consumePendingShopCart())],s=[...new Set([...a,...o])],c=s.map(e=>({id:e}));if(o.length){let e=s.length-a.length;window.showToast(`Added ${e} new item${e===1?``:`s`} from your recommended combination.`)}u();function u(){t.setShopCart(c.map(e=>e.id))}function d(){let a=t.getOwnedPerfumes().monAccord||[];ut(a,c),e.innerHTML=`
      <div class="page__container">
                  ...
                  <div class="shop-region-card__products">
                    ${t?(()=>{let n=c.find(e=>e.id===t.id),r=a.includes(t.id);return`
                        <button class="shop-bottle-btn ${n?`shop-bottle-btn--in-cart`:``} ${r?`shop-bottle-btn--owned`:``}" data-id="${t.id}" style="--region-color:${e.color};">
                          ...
                          <img src="${st[e.id]}" class="shop-bottle-img" alt="Spray" loading="lazy" decoding="async" />
                    ...
                    ${n?(()=>{let t=c.find(e=>e.id===n.id),r=a.includes(n.id);return`
                        <button class="shop-bottle-btn ${t?`shop-bottle-btn--in-cart`:``} ${r?`shop-bottle-btn--owned`:``}" data-id="${n.id}" style="--region-color:${e.color};">
                          ...
                          ${r?`<div class="shop-bottle-owned">Owned</div>`:``}
                          <img src="${ct[e.id]}" class="shop-bottle-img" alt="Oil" loading="lazy" decoding="async" />
    ...
    `,ft(),e.querySelectorAll(`.shop-bottle-btn`).forEach(e=>{e.addEventListener(`click`,t=>{t.stopPropagation();let n=e.dataset.id,r=c.findIndex(e=>e.id===n);r>=0?c.splice(r,1):c.push({id:n}),u(),d()})}),e.querySelectorAll(`.shop-cart__item-remove`).forEach(e=>{e.addEventListener(`click`,()=>{c=c.filter(t=>t.id!==e.dataset.id),u(),d()})});let o=e.querySelector(`#btn-confirm-order`);o&&o.addEventListener(`click`,()=>{dt(c,e,n)})}d()}function ut(e,t){if(!e.length)return null;let n=t.map(e=>e.id),r=e.map(e=>l(e)).filter(Boolean),a=[...new Set(r.flatMap(e=>e.scentFamily.split(`-`)))],o=i.filter(t=>!e.includes(t.id)&&!n.includes(t.id)&&t.scentFamily.split(`-`).some(e=>a.includes(e))).slice(0,2);return o.length?`Based on your owned ${r.map(e=>e.name).join(` & `)}: try adding ${o.map(e=>e.name).join(` or `)}.`:null}function dt(e,n,r){t.clearShopCart();let i=document.createElement(`div`);i.className=`modal-overlay`,i.innerHTML=`
        ...
        <div class="order-retailers">
          <div class="order-retailers__grid">
            <div class="order-retailer-card" aria-label="Sephora">
              <img src="${rt}" alt="Sephora" class="order-retailer-card__logo" loading="lazy" decoding="async" />
            </div>
            <div class="order-retailer-card" aria-label="Boyner">
              <img src="${it}" alt="Boyner" class="order-retailer-card__logo" loading="lazy" decoding="async" />
            </div>
            <div class="order-retailer-card" aria-label="Trendyol">
              <img src="${at}" alt="Trendyol" class="order-retailer-card__logo" loading="lazy" decoding="async" />
            </div>
            <div class="order-retailer-card" aria-label="Hepsiburada">
              <img src="${ot}" alt="Hepsiburada" class="order-retailer-card__logo" loading="lazy" decoding="async" />
            </div>
          </div>
        </div>
  ...
  `,document.body.appendChild(e),document.getElementById(`dt-skip`).addEventListener(`click`,Z),document.getElementById(`dt-next`).addEventListener(`click`,()=>{clearTimeout(X),clearInterval(q),Nt()})}function Ft(){document.getElementById(`dt-card`)?.remove(),document.getElementById(`dt-flash`)?.remove()}function It(){J&&Z(),V=window.location.hash||``,H=mt(localStorage),U=mt(sessionStorage),W=window.__retakeQuiz,localStorage.clear(),sessionStorage.clear(),delete window.__retakeQuiz,localStorage.removeItem(vt),J=!0,Y=0,Pt(),Mt(0)}function Z(){J=!1,clearTimeout(X),clearInterval(q),ht(localStorage,H),ht(sessionStorage,U),H=null,U=null,W===void 0?delete window.__retakeQuiz:window.__retakeQuiz=W,W=void 0,(V||``)!==(window.location.hash||``)&&(window.location.hash=V||`#landing`),V=``,Ft()}function Lt(){if(document.getElementById(`dt-styles`))return;let e=document.createElement(`style`);e.id=`dt-styles`,e.textContent=`
    #dt-card {
      position: fixed;
      z-index: 99995;
      top: 0;
  ...
  `,document.head.appendChild(e)}var Q=document.getElementById(`app`);function $(e){document.documentElement.setAttribute(`data-theme`,e),t.set(`theme`,e)}function Rt(){let e=t.get(`theme`,`dark`);document.documentElement.setAttribute(`data-theme`,e)}var zt={"":f,"#landing":f,"#profile":de,"#lab":Pe,"#vault":We,"#shop":lt,"#community":et};function Bt(){return window.location.hash||``}function Vt(e){window.location.hash=e}function Ht(){let e=Bt(),t=zt[e]||f;Q.innerHTML=``,Q.appendChild(n(Vt,e));let r=document.createElement(`div`);if(r.className=`page page-enter`,r.id=`page-content`,t(r,Vt),Q.appendChild(r),!document.querySelector(`.toast-container`)){let e=document.createElement(`div`);e.className=`toast-container`,e.id=`toast-container`,document.body.appendChild(e)}window.scrollTo({top:0,behavior:`auto`})}window.showToast=function(e,t=`success`){let n=document.getElementById(`toast-container`);if(!n)return;let r=document.createElement(`div`);r.className=`toast toast--${t}`,r.innerHTML=`<span class="toast__message">${e}</span>`,n.appendChild(r),setTimeout(()=>{r.style.animation=`fadeOut 0.3s var(--ease-out) forwards`,setTimeout(()=>r.remove(),300)},3e3)},window.showSettings=function(){let e=document.querySelector(`.modal-overlay`);e&&e.remove();let n=t.get(`theme`,`dark`),r=document.createElement(`div`);r.className=`modal-overlay`,r.id=`settings-modal`,r.innerHTML=`
    <div class="modal">
      <div class="modal__header">
